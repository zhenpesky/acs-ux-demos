import{cj as re,m8 as G,m9 as ie,ma as Se,mb as Nt,dx as de,eH as be,mc as Xe,md as Ye,w as e,aF as H,aG as W,a4 as F,me as Je,mf as Tt,aH as h,mg as ze,mh as Ce,lV as Ft,lW as Lt,dj as le,lY as Ot,lZ as It,aI as Z,aw as d,mi as Dt,b8 as ce,mj as ue,l_ as et,l$ as Ee,m0 as tt,bb as Pt,cw as Ve,am as Ne,mk as $t,ml as X,mm as xe,mn as me,mo as nt,dP as k,bN as Te,et as wt,d6 as st,mp as At,cA as Fe,cz as Le,lO as Oe,cB as Ie,jS as qt,mq as De,dy as Pe,mr as Rt,bO as _t,kC as kt,kD as Bt,kE as Mt,lQ as $e,ms as ot,mt as at,mu as rt,mv as we,lH as Ae,mw as qe,mx as zt,ao as he,ab as S,aB as B,ac as pe,aC as Ue,ai as Ut,bT as Qt,bU as Kt,my as Gt,aW as Ht,bS as Wt,K as Zt,mz as Xt,mA as Yt,jE as Jt,mB as Re,ff as en,mC as M,mD as je,mE as ge,mF as it,mG as dt,mH as tn,mI as lt,b9 as Y,aQ as nn,aS as sn,aT as on,bK as an,bo as Qe,bi as ct,mJ as ut,be as xt,bf as mt,mK as ht,bg as pt,e6 as _e,mL as rn,bh as K,mM as jt,mN as oe,mO as gt,d_ as yt,fX as ae,mP as Ct,cy as ft,mQ as dn,e5 as ln,aZ as ne,dd as fe,mR as cn,mS as un,mT as xn,bk as ve,bX as vt,cq as St,dM as bt,bl as mn,cm as hn,cn as q,co as R,cp as _,mU as ye,ad as pn,ae as Ke,b4 as jn,mV as gn,cg as yn,ch as se,f2 as Cn}from"./index-ClxsFAnf.js";import{u as O,g as V,f as fn,r as vn}from"./apollo-BxVF6eGb.js";import{u as Sn,a as bn,b as En,S as Vn,c as Nn,E as Ge}from"./ExpandableLabelSection-T8maGFJm.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-a0GAo0rY.js";const Tn=V`
...
`;function $n({querySearchFilter:n,...t}){return O(Pn,{variables:{query:G(n),pagination:re(t)}})}const wn=[X,xe,me,nt],We={field:X,direction:"asc"};function An({querySearchFilter:n,isFiltered:t,pagination:s,sortOption:r,getSortParams:o,onClearFilters:a}){var f;const{page:m,perPage:c}=s,{data:i,previousData:g,loading:x,error:y}=$n({querySearchFilter:n,page:m,perPage:c,sortOption:r}),j=i??g,C=de({isLoading:x,data:j==null?void 0:j.nodes,error:y,searchFilter:n}),b=(f=n.SEVERITY)==null?void 0:f.map(l=>Xe[l]).filter(Ye);return e.jsxs(H,{borders:C.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":x?"true":"false",children:[e.jsx(W,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(h,{sort:o(X),children:"Node"}),e.jsxs(h,{children:["CVEs by severity",t&&e.jsx(Ce,{})]}),e.jsx(h,{sort:o(xe),children:"Cluster"}),e.jsx(h,{sort:o(me),children:"Operating system"}),e.jsx(h,{sort:o(nt),children:"Scan time"})]})}),e.jsx(le,{tableState:C,colSpan:5,emptyProps:{message:"No CVEs have been reported for your scanned nodes"},filteredEmptyProps:{onClearFilters:a},renderer:({data:l})=>e.jsx(Z,{children:l.map(v=>{const{id:T,name:E,nodeCVECountBySeverity:I,cluster:D,osImage:N,scanTime:L}=v,{critical:u,important:p,moderate:P,low:A,unknown:z}=I;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Node",modifier:"nowrap",children:e.jsx(ce,{to:ue("Node",T),children:e.jsx(k,{position:"middle",content:E})})}),e.jsx(d,{dataLabel:"CVEs by severity",children:e.jsx(et,{criticalCount:u.total,importantCount:p.total,moderateCount:P.total,lowCount:A.total,unknownCount:z.total,filteredSeverities:b,entity:"node"})}),e.jsx(d,{dataLabel:"Cluster",modifier:"nowrap",children:e.jsx(k,{position:"middle",content:D.name})}),e.jsx(d,{dataLabel:"Operating system",modifier:"nowrap",children:e.jsx(k,{position:"middle",content:N})}),e.jsx(d,{dataLabel:"Scan time",children:e.jsx(tt,{date:L})})]},T)})})})]})}const qn=V`
    query getNodeCVEEntityCounts($query: String) {
        nodeCVECount(query: $query)
        nodeCount(query: $query)
    }
`;function Rn(n){return O(qn,{variables:{query:G(n)}})}const _n=[ot,at,rt,we];function kn(){var te;const n=fn(),{analyticsTrack:t}=Te(),s=Ae(t),{isFeatureFlagEnabled:r}=wt(),o=r("ROX_SCANNER_V4")&&r("ROX_NODE_INDEX_ENABLED"),[a]=st("entityTab",At),{searchFilter:m,setSearchFilter:c}=Fe(),i=Le(Oe),{sortOption:g,getSortParams:x,setSortOption:y}=Ie({sortFields:a==="CVE"?In:wn,defaultSortOption:a==="CVE"?He:We,onSort:()=>i.setPage(1)});qt({destination:"node-cves",searchFilter:m,setSearchFilter:c,reapplyWhen:[a],onScopeApplied:()=>i.setPage(1)});const j=De(m),C=Pe(j),b=((te=j["CVE Snoozed"])==null?void 0:te[0])==="true",f=Sn(),l=Rt(),{snoozeModalOptions:v,setSnoozeModalOptions:T,snoozeActionCreator:E}=bn(),I=En("Node"),{version:D}=_t();function N($){i.setPage(1),y($==="CVE"?He:We),t({event:Xt,properties:{type:$,page:"Overview"}})}vn.useEffect(()=>{N(a)},[]);function L(){c({}),i.setPage(1)}const{data:u}=Rn(j),p={CVE:(u==null?void 0:u.nodeCVECount)??0,Node:(u==null?void 0:u.nodeCount)??0},P=kt(),A=P==="v1"||P==="v2",z=Bt({enabled:A&&P==="v1",searchFilter:m,setSearchFilter:c,paginationSetPage:()=>i.setPage(1),storageScope:"node-cves",filterKind:"workload"}),U=Mt({enabled:A&&P==="v2",searchFilter:m,setSearchFilter:c,paginationSetPage:()=>i.setPage(1),storageScope:"node-cves",filterKind:"workload"}),Q=P==="v2"?U:z,J=e.jsx($e,{searchFilter:m,searchFilterConfig:_n,defaultSearchFilterEntity:"Node",onFilterChange:($,w)=>{c($),i.setPage(1),s(qe,w)},prefixToolbarItems:Q.prefixToolbarItem??void 0,appliedFilterSuffix:Q.appliedFilterSuffix??void 0}),ee=e.jsx(Yt,{entityTabs:["CVE","Node"],entityCounts:p,onChange:N});return e.jsxs(e.Fragment,{children:[v&&e.jsx(Vn,{...v,onSuccess:($,w)=>{$==="SNOOZE"&&t({event:zt,properties:{type:"NODE",duration:w}}),n.cache.evict({fieldName:"nodeCVEs"}),n.cache.evict({fieldName:"nodeCVECount"}),n.cache.gc(),l.clear()},onClose:()=>T(null)}),e.jsx(he,{title:"Node CVEs Overview"}),e.jsx(S,{children:e.jsxs(B,{alignItems:{default:"alignItemsCenter"},grow:{default:"grow"},children:[e.jsxs(B,{direction:{default:"column"},grow:{default:"grow"},children:[e.jsx(pe,{headingLevel:"h1",children:"Node CVEs"}),e.jsx(Ue,{children:"Prioritize and manage scanned CVEs across nodes"})]}),e.jsx(Ue,{children:e.jsx(Nn,{searchFilter:m,setSearchFilter:c,snoozedCveCount:I})})]})}),o&&e.jsx(S,{children:e.jsx(Ut,{isInline:!0,variant:"info",title:"Results may include Node CVEs obtained from Scanner V4",component:"p",children:e.jsx(Qt,{children:e.jsx("a",{href:Kt(D,"operating/managing-vulnerabilities#understanding-node-cves-scanner-v4_scan-rhcos-node-host"),target:"_blank",rel:"noopener noreferrer",children:"Read more about the differences between the node scanning results obtained with the StackRox Scanner and Scanner V4."})})})}),P==="v2"&&U.wysiwygAlert&&e.jsx(S,{children:U.wysiwygAlert}),e.jsxs(S,{isCenterAligned:!0,children:[e.jsx(Gt,{filterToolbar:J,entityToggleGroup:ee,pagination:i,tableRowCount:a==="CVE"?p.CVE:p.Node,isFiltered:C,children:f&&e.jsx(Ht,{align:{default:"alignEnd"},children:e.jsx(Wt,{toggleText:"Bulk actions",isDisabled:l.size===0,children:e.jsx(Zt,{onClick:()=>T({action:b?"UNSNOOZE":"SNOOZE",cveType:"NODE_CVE",cves:Array.from(l.values())}),children:b?"Unsnooze CVEs":"Snooze CVEs"},"bulk-snooze-cve")})})}),a==="CVE"&&e.jsx(Dn,{querySearchFilter:j,isFiltered:C,pagination:i,selectedCves:l,canSelectRows:f,createRowActions:E("NODE_CVE",b?"UNSNOOZE":"SNOOZE"),sortOption:g,getSortParams:x,onClearFilters:L}),a==="Node"&&e.jsx(An,{querySearchFilter:j,isFiltered:C,pagination:i,sortOption:g,getSortParams:x,onClearFilters:L})]}),Q.modalsFragment]})}function Bn(n,t){const s=en(n,r=>{var o,a;switch(t.field){case"Component":return(o=r.name)==null?void 0:o.toLowerCase();case"Type":return(a=r.source)==null?void 0:a.toLowerCase();default:return""}});return t.reversed&&s.reverse(),s}const Et=V`
...
`;function Zn({query:n,...t}){var r,o;const s=O(Wn,{variables:{query:n,pagination:re(t)}});return{affectedNodesRequest:s,nodeData:((r=s.data)==null?void 0:r.nodes)??((o=s.previousData)==null?void 0:o.nodes)}}const Xn=V`
...
`;function Yn(n){const t=O(Xn,{variables:{cve:n}}),{data:s,previousData:r}=t,o=(s==null?void 0:s.nodeCVE)??(r==null?void 0:r.nodeCVE);return{metadataRequest:t,cveData:o}}const Jn=V`
