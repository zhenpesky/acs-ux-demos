import{ck as re,mb as Q,mc as ie,md as Se,me as Nt,dD as de,eN as be,mf as Ze,mg as Xe,w as e,aG as W,aH as H,a5 as F,mh as Je,mi as Tt,aI as p,mj as ze,mk as Ce,lY as Ft,lZ as Lt,dq as le,l$ as It,m0 as Ot,aJ as Y,ax as d,ml as Dt,b9 as ce,mm as ue,m1 as et,m2 as Ee,m3 as tt,bc as Pt,cx as Ve,an as Ne,mn as $t,mo as Z,mp as xe,mq as me,mr as nt,dV as k,bO as Te,ez as qt,d7 as st,ms as At,cB as Fe,cA as Le,lR as Ie,cC as Oe,jW as Rt,mt as De,dE as Pe,mu as wt,bP as _t,kG as kt,kH as Bt,kI as Mt,lT as $e,mv as ot,mw as at,mx as rt,my as qe,lK as Ae,mz as Re,mA as zt,ap as pe,ac as S,aC as B,ad as he,aD as Ue,aj as Ut,bU as Kt,bV as Gt,mB as Qt,aX as Wt,bT as Ht,K as Yt,mC as Zt,mD as Xt,jI as Jt,mE as we,fl as en,mF as M,mG as je,mH as ge,mI as it,mJ as dt,mK as tn,mL as lt,ba as X,aR as nn,aT as sn,aU as on,bL as an,bp as Ke,bj as ct,mM as ut,bf as xt,bg as mt,mN as pt,bh as ht,ec as _e,mO as rn,bi as G,mP as jt,mQ as oe,mR as gt,e4 as yt,g1 as ae,mS as Ct,cz as ft,mT as dn,eb as ln,a_ as ne,dj as fe,mU as cn,mV as un,mW as xn,bl as ve,bY as vt,cr as St,dS as bt,bm as mn,cn as pn,co as R,cp as w,cq as _,mX as ye,ae as hn,af as Ge,b5 as jn,mY as gn,ch as yn,ci as se,f8 as Cn}from"./index-ZSWvPtTB.js";import{u as I,g as V,f as fn,r as vn}from"./apollo-BxVF6eGb.js";import{u as Sn,a as bn,b as En,S as Vn,c as Nn,E as Qe}from"./ExpandableLabelSection-BoV6cHSk.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-Baf9Ngar.js";const Tn=V`
...
`,Mn=["Component","Type"],zn={field:"Component",direction:"asc"};function Vt({data:n}){const{sortOption:t,getSortParams:s}=Jt({sortFields:Mn,defaultSortOption:zn}),r=Bn(n,t);return n.length===0?null:e.jsxs(W,{children:[e.jsx(H,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(p,{sort:s("Component"),children:"Component"}),e.jsx(p,{children:"Version"}),e.jsx(p,{children:"CVE fixed in"}),e.jsx(p,{sort:s("Type"),children:"Type"})]})}),e.jsx(Y,{children:r.map(({name:o,source:a,version:m,nodeVulnerabilities:c})=>{var g;const i=(g=c==null?void 0:c[0])==null?void 0:g.fixedByVersion;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Component",children:o}),e.jsx(d,{dataLabel:"Version",children:m}),e.jsx(d,{dataLabel:"CVE fixed in",children:i||e.jsx(we,{isFixable:!1})}),e.jsx(d,{dataLabel:"Type",children:a})]},o)})})]})}const Un=[Z,M,je,ge,xe,me],Kn={field:M,direction:"desc"},Gn=V`
    ${Et}
...
`;function Yn({query:n,...t}){var r,o;const s=I(Hn,{variables:{query:n,pagination:re(t)}});return{affectedNodesRequest:s,nodeData:((r=s.data)==null?void 0:r.nodes)??((o=s.previousData)==null?void 0:o.nodes)}}const Zn=V`
