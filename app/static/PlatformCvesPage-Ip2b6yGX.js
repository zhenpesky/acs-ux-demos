import{m7 as B,mM as Me,mN as Y,mO as J,cc as ee,lV as te,ds as se,w as e,az as re,aA as ae,Z as $,aB as f,m2 as ke,de as ne,aC as ie,aq as d,b1 as le,mP as oe,b2 as R,mQ as Ee,lW as ce,mR as ue,mp as N,eA as Ue,l$ as ze,m0 as jt,m1 as gt,m3 as bt,mm as Se,mS as Ke,lM as Qe,b4 as vt,cr as Ge,ag as _,m5 as We,bG as Te,d1 as He,mT as Et,cv as Ve,cu as Fe,lz as Le,cw as Pe,mb as Ie,dt as $e,mc as St,kl as Tt,km as Vt,kn as Ft,lB as De,md as Ze,mU as Xe,ls as qe,mV as Oe,mi as Lt,ai as de,a5 as b,av as D,a6 as z,aw as je,mj as Pt,aP as It,bL as $t,K as Dt,mW as qt,ml as Ot,mr as At,dI as _t,aK as me,aL as xe,aM as pe,bD as ge,bh as U,bb as Ye,b7 as Je,b8 as et,mv as tt,b9 as st,d$ as Ae,d_ as rt,aS as be,d8 as _e,bM as Rt,mB as at,ba as K,mx as nt,my as Z,dT as it,fQ as X,mA as lt,ct as ot,bd as ve,bQ as ct,cl as ut,ce as dt,be as Bt,ch as Nt,ci as Q,cj as G,ck as W,mX as mt,dZ as wt,fz as Mt,dY as kt,mD as Ut,mF as fe,a7 as zt,a8 as Re,aZ as Kt,mG as Qt,c9 as Gt,ca as H,eX as Wt}from"./index-B4SzKVNU.js";import{u as I,g as j,f as Ht,r as Zt}from"./apollo-BxVF6eGb.js";import{u as Xt,a as Yt,b as Jt,S as es,c as ts,E as ss}from"./ExpandableLabelSection-CYXA69L0.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-0hPbd246.js";const rs=j`
...
`;function Bs({tableState:s,getSortParams:t,onClearFilters:a}){const r=Ue();return e.jsxs(re,{borders:s.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":s.type==="LOADING"?"true":"false",children:[e.jsx(ae,{noWrap:!0,children:e.jsxs($,{children:[e.jsx(ze,{}),e.jsx(f,{sort:t(ce),children:"CVE"}),e.jsx(f,{sort:t(mt),children:"CVE status"}),e.jsx(f,{sort:t(ue),children:"CVE type"}),e.jsx(f,{sort:t(N),children:"CVSS"})]})}),e.jsx(ne,{tableState:s,colSpan:5,emptyProps:{message:"No CVEs were detected for this cluster"},filteredEmptyProps:{onClearFilters:a},renderer:({data:i})=>i.map((l,o)=>{const{id:c,cve:m,isFixable:u,vulnerabilityType:v,cvss:g,scoreVersion:T,summary:x}=l,V=r.has(m);return e.jsxs(ie,{isExpanded:V,children:[e.jsxs($,{children:[e.jsx(d,{expand:{rowIndex:o,isExpanded:V,onToggle:()=>r.toggle(m)}}),e.jsx(d,{dataLabel:"CVE",modifier:"nowrap",children:e.jsx(le,{to:oe("CVE",c),children:m})}),e.jsx(d,{dataLabel:"CVE status",children:e.jsx(Se,{isFixable:u})}),e.jsx(d,{dataLabel:"CVE type",children:Ke(v)}),e.jsx(d,{dataLabel:"CVSS",children:e.jsx(Qe,{cvss:g,scoreVersion:T})})]}),e.jsxs($,{isExpanded:V,children:[e.jsx(d,{}),e.jsx(d,{colSpan:4,children:e.jsx(Ge,{children:x?e.jsx(_,{component:"p",children:x}):e.jsx(We,{})})})]})]},m)})})]})}const Ns=j`
    ${Rs}
