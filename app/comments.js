...
(function () {
  ...
  var Popup = {
    ...
    showNewForm: function (x, y, clientX, clientY) {
      ...
      var taWrap = el('div', { className: 'pf-v6-c-form-control rhacs-popup__form-ctrl' });
    ...
    showThread: function (pinId) {
      ...
      // Reply form
      var replyWrap = el('div', { className: 'pf-v6-c-form-control rhacs-popup__form-ctrl rhacs-popup__form-ctrl--reply' });
    ...
    showEdit: function (pin, bodyEl) {
      bodyEl.innerHTML = '';
      var editWrap = el('div', { className: 'pf-v6-c-form-control rhacs-popup__form-ctrl' });
