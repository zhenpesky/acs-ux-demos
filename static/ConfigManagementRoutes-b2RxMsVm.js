import{q as D,f3 as j,t as e,fn as xn,a8 as U,aY as gs,ah as Xe,fo as xs,f6 as B,fp as yn,b0 as Re,fh as cs,f2 as Nn,eZ as bn,fq as jn,aa as Sn,ck as En,A as be,fr as pt,af as Tn,fb as Rn,fs as yt,ft as Nt,fu as vn,fv as Pn,eV as te,fj as bt,cp as jt,aj as An,ak as $n,f4 as St,fw as In,d6 as ee,fc as Et,fx as Tt,cx as wn,fy as Rt,fz as On,fA as Ln,dC as Un,ei as qn,fB as Dn,db as We,fC as ys,fg as kn,fD as vt,fE as Pt,fi as Ns,ew as Mn,c8 as Fn,c9 as _}from"./index-S74g0eRP.js";import{r as I,c as us,P as C}from"./redoc-DSdxMpMR.js";import{s as G,w as De}from"./URLSearchInputWithAutocomplete-BiL3BEYp.js";import{E as At,D as $t,e as ne,m as ds,T as _n,B as Yn,a as Vn,L as ms,c as ps,P as Qe,d as Te,i as Ve,n as He,b as me,p as pe,r as Ge,s as Le,f as Ue,g as Be,h as Hn,j as Gn,k as It,C as V,M as je,l as Bn,o as Ct,q as wt,t as Qn,u as Wn,v as Cs,w as Ot,S as Lt,G as Kn}from"./GroupedTabs-8FV_JkVT.js";import{E as bs,d as z,u as zn,a as Jn,S as Xn,C as Zn,B as js,f as ea,e as sa}from"./ControlDetails-BCoOraRM.js";import{u as k,U as b,g as H,W as Y,S as Ut,b as ta,G as na,a as aa,X as ra,c as oa,M as la,L as ia,Y as ca,e as Ke,i as ae,o as qt,f as Ss,T as O,p as he,q as fe,r as ge,s as xe,P as Dt,t as ua}from"./URLSearchInput-DlM5MQb4.js";import{q as w,T as Ze,d as x,a as $,n as M,D as da,b as ma,I as pa,c as Ca,P as ha,K as fa,S as ga,e as xa,f as ya}from"./queryService-rWKxACc_.js";import{g as q,u as kt}from"./apollo-Bv6hvkNJ.js";import{s as Pe,a as ht,p as Na}from"./policy.proto-UGifO4do.js";import{g as ba}from"./mathUtils-DiJFKe7q.js";import{s as Ce}from"./standards-Br0QJ-XZ.js";import{N as Z,P as Es,b as Ts,c as Mt,d as Rs,e as vs,f as Ft,h as _t,C as ja,g as Sa}from"./search-ANzw9wHk.js";import{s as Yt}from"./startCase-nnHaORJd.js";import{r as es}from"./object-resolve-path-esx_DSkd.js";import{s as hs,a as Ea,b as Vt,c as Ta}from"./sorters-DROgS-i8.js";import{P as Ra}from"./PolicyDisabledIconText-DIqbTfWV.js";import{P as ss,f as Ps}from"./policies.utils-dYxkuPa1.js";import{C as va}from"./CloseButton-DkNzWpmw.js";import{c as Pa}from"./controls-CGUivZmM.js";import{A as Aa}from"./_baseGt-Cfr0BTzT.js";import"./lodash-JMWJiBov.js";import"./searchOptionsToQuery-Q3UHmnOv.js";import"./react-onclickoutside.es-CH1EXexV.js";import"./react-popper-BNlnbwer.js";import"./popper-U5NbITwx.js";import"./index-vnJqCFL6.js";import"./Progress-DdOTtQZz.js";import"./times-circle-icon-DhGWoEdG.js";import"./d3-D72bN1z7.js";import"./check-circle-Cn2Su2yo.js";import"./_createCompounder-Bo9qACOw.js";import"./omit-BO1K8xhd.js";import"./_flatRest-DstPrrJV.js";import"./TableCellValue-B4KUVm-T.js";import"./set-C3FKd538.js";import"./_baseSet-MN3InYbZ.js";function fs(){return fs=Object.assign||function(s){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var o in a)Object.prototype.hasOwnProperty.call(a,o)&&(s[o]=a[o])}return s},fs.apply(this,arguments)}function $a(s,t){if(s==null)return{};var a=Ia(s,t),o,n;if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(s);for(n=0;n<r.length;n++)o=r[n],!(t.indexOf(o)>=0)&&Object.prototype.propertyIsEnumerable.call(s,o)&&(a[o]=s[o])}return a}function Ia(s,t){if(s==null)return{};var a={},o=Object.keys(s),n,r;for(r=0;r<o.length;r++)n=o[r],!(t.indexOf(n)>=0)&&(a[n]=s[n]);return a}var As=I.forwardRef(function(s,t){var a=s.color,o=a===void 0?"currentColor":a,n=s.size,r=n===void 0?24:n,l=$a(s,["color","size"]);return us.createElement("svg",fs({ref:t,xmlns:"http://www.w3.org/2000/svg",width:r,height:r,viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},l),us.createElement("line",{x1:"5",y1:"12",x2:"19",y2:"12"}),us.createElement("polyline",{points:"12 5 19 12 12 19"}))});As.propTypes={color:C.string,size:C.oneOfType([C.string,C.number])};As.displayName="ArrowRight";const wa=q`
    query numPolicies($query: String) {
        policyCount(query: $query)
    }
`,Oa=()=>{const s=k(),t=D(),a=b.getURL(s,t).base(j.POLICY).url();return e.jsx(H,{query:wa,variables:{query:w.objectToWhereClause({"Lifecycle Stage":"DEPLOY"})},children:({loading:o,data:n})=>{const r=(n==null?void 0:n.policyCount)||0;return e.jsx(At,{count:r,entityType:j.POLICY,url:a,loading:o,position:"first",short:!0})}})},La=q`
    query numCISControls {
        executedControlCount(query: "Standard: CIS")
    }
`,Ua=()=>{const{loading:s,error:t,data:a}=kt(La);t&&xn(t);const o=k(),n=D(),r=b.getURL(o,n).base(j.CONTROL).url(),l=(a==null?void 0:a.executedControlCount)||0;return e.jsx(At,{count:l,entityType:j.CONTROL,url:r,loading:s,position:"middle",short:!0})},qa=s=>U(ne[s]),Da=(s,t)=>t.map(a=>({label:qa(a),link:s.base(a).url()})),ka=()=>{const s=[j.CLUSTER,j.NAMESPACE,j.NODE,j.DEPLOYMENT,j.IMAGE,j.SECRET],t=k(),a=D(),o=b.getURL(t,a),n=Da(o,s);return e.jsx($t,{text:"Application & Infrastructure",options:n})},Ma=s=>U(ne[s]),Fa=(s,t)=>t.map(a=>({label:Ma(a),link:s.base(a).url()})),_a=()=>{const s=[j.SUBJECT,j.SERVICE_ACCOUNT,j.ROLE],t=k(),a=D(),o=b.getURL(t,a),n=Fa(o,s);return e.jsx($t,{text:"Role-Based Access Control",options:n})},Ht=({isExporting:s,setIsExporting:t})=>{const{hasReadAccess:a}=gs(),o=a("WorkflowAdministration"),n=a("Compliance");return e.jsxs("div",{className:"flex flex-1 justify-end",children:[e.jsxs("div",{className:"border-base-400 border-r-2 mr-1 flex ",children:[o&&e.jsx(Oa,{}),n&&e.jsx(Ua,{}),e.jsx("div",{className:"flex w-32 mr-2",children:e.jsx(ka,{})}),e.jsx("div",{className:"flex w-32 mr-3 ",children:e.jsx(_a,{})})]}),e.jsx("div",{className:"flex items-center self-center",children:e.jsx(bs,{fileName:"Config Management Dashboard Report",type:null,page:Xe.CONFIG_MANAGEMENT,pdfId:"capture-dashboard",isExporting:s,setIsExporting:t})})]})};Ht.propTypes={isExporting:C.bool.isRequired,setIsExporting:C.func.isRequired};const $s={READY:7},Ya=Na.map(s=>({title:yn[s],color:xs[s]})),Gt="var(--base-400)",Oe={PASS:"Pass",FAIL:"Fail"},Va=q`
