import{m4 as B,mJ as Me,mK as Y,mL as J,ca as ee,lS as te,dq as se,t as e,ax as re,ay as ae,X as $,az as f,l$ as ke,dc as ne,aA as ie,ao as d,a$ as le,mM as oe,b0 as R,mN as Ee,lT as ce,mO as ue,mm as N,ey as Ue,lY as Ke,lZ as jt,l_ as gt,m0 as bt,mj as Se,mP as ze,lJ as Qe,b2 as vt,cp as Ge,ae as _,m2 as We,bE as Te,c$ as He,mQ as Et,ct as Ve,cs as Fe,lw as Le,cu as Pe,m8 as Ie,dr as $e,m9 as St,ki as Tt,kj as Vt,kk as Ft,ly as De,ma as Ze,mR as Xe,lp as qe,mS as Oe,mf as Lt,ag as de,a3 as b,at as D,a4 as K,au as je,mg as Pt,aN as It,bJ as $t,I as Dt,mT as qt,mi as Ot,mo as At,dG as _t,aI as xe,aJ as pe,aK as me,bB as ge,bf as U,b9 as Ye,b5 as Je,b6 as et,ms as tt,b7 as st,dZ as Ae,dY as rt,aQ as be,d6 as _e,bK as Rt,my as at,b8 as z,mu as nt,mv as Z,dR as it,fO as X,mx as lt,cr as ot,bb as ve,bO as ct,cj as ut,cc as dt,bc as Bt,cf as Nt,cg as Q,ch as G,ci as W,mU as xt,dX as wt,fx as Mt,dW as kt,mA as Ut,mC as fe,a5 as Kt,a6 as Re,aX as zt,mD as Qt,c7 as Gt,c8 as H,eV as Wt}from"./index-BRaDJnQx.js";import{u as I,g as j,f as Ht,r as Zt}from"./apollo-BxVF6eGb.js";import{u as Xt,a as Yt,b as Jt,S as es,c as ts,E as ss}from"./ExpandableLabelSection-D6bUEVcR.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-DwTlIGCP.js";const rs=j`
...
`;function fs({tableState:s,getSortParams:t,onClearFilters:a}){return e.jsxs(re,{borders:s.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":s.type==="LOADING"?"true":"false",children:[e.jsx(ae,{noWrap:!0,children:e.jsxs($,{children:[e.jsx(f,{sort:t(B),children:"Cluster"}),e.jsx(f,{sort:t(Y),children:"Cluster type"}),e.jsx(f,{children:"CVE status"}),e.jsx(f,{sort:t(J),children:"Kubernetes version"})]})}),e.jsx(ne,{tableState:s,colSpan:3,emptyProps:{message:"No clusters have been reported for this CVE"},filteredEmptyProps:{onClearFilters:a},renderer:({data:n})=>e.jsx(ie,{children:n.map(({id:r,name:i,type:l,clusterVulnerabilities:o,status:c})=>{var u;const x=At(o);return e.jsxs($,{children:[e.jsx(d,{dataLabel:"Cluster",children:e.jsx(le,{to:oe("Cluster",r),children:e.jsx(_t,{position:"middle",content:i})})}),e.jsx(d,{dataLabel:"Cluster type",modifier:"nowrap",children:Ee(l)}),e.jsx(d,{dataLabel:"CVE status",children:e.jsx(Se,{isFixable:x})}),e.jsx(d,{dataLabel:"Kubernetes version",modifier:"nowrap",children:((u=c==null?void 0:c.orchestratorMetadata)==null?void 0:u.version)??"Unavailable"})]},r)})})})]})}const js=j`
    ${ys}
...
`;function Ws({data:s}){return e.jsxs(xe,{isCompact:!0,isFullHeight:!0,children:[e.jsx(pe,{children:"CVEs by type"}),e.jsx(me,{children:e.jsx(D,{direction:{default:"column"},children:Qs.map(({type:t,field:a})=>e.jsx(je,{span:12,children:e.jsx(_,{component:"p",children:R(s[a],t)})},t))})})]})}const Hs=j`
    ${Ks}
    ${Gs}
...
`;function Zs(s,t){return I(Hs,{variables:{id:s,query:t}})}const Xs=[Xe];function Ys({clusterId:s}){var S,q;const{analyticsTrack:t}=Te(),a=qe(t),{searchFilter:n,setSearchFilter:r}=Ve(),i=Ie(n),l=kt(i),o=$e(i),{page:c,perPage:x,setPage:u,setPerPage:v}=Fe(Le),{sortOption:g,getSortParams:T}=Pe({sortFields:As,defaultSortOption:_s,onSort:()=>u(1)}),{data:p,loading:V,error:P}=ws({clusterId:s,query:l,page:c,perPage:x,sortOption:g}),E=Zs(s,l),F=Ut(i),m=((S=p==null?void 0:p.cluster)==null?void 0:S.clusterVulnerabilityCount)??0,y=se({isLoading:V,error:P,data:(q=p==null?void 0:p.cluster)==null?void 0:q.clusterVulnerabilities,searchFilter:i});return e.jsxs(e.Fragment,{children:[e.jsx(b,{component:"div",children:e.jsx(_,{component:"p",children:"Review and triage vulnerability data scanned on this cluster"})}),e.jsx(z,{component:"div"}),e.jsxs(b,{hasBodyWrapper:!1,isFilled:!0,children:[e.jsx(De,{className:"pf-v6-u-pb-0 pf-v6-u-px-sm",searchFilter:n,searchFilterConfig:Xs,cveStatusFilterField:"CLUSTER CVE FIXABLE",onFilterChange:(h,C)=>{r(h),a(Oe,C)},includeCveSeverityFilters:!1}),e.jsxs(nt,{isLoading:E.loading,error:E.error,children:[e.jsx(Z,{loadingText:"Loading platform CVEs by status summary",data:E.data,renderer:({data:h})=>e.jsx(zs,{data:h.cluster.platformCVECountByFixability,hiddenStatuses:F})}),e.jsx(Z,{loadingText:"Loading platform CVEs by type summary",data:E.data,renderer:({data:h})=>e.jsx(Ws,{data:h.cluster.platformCVECountByType})})]}),e.jsx(z,{component:"div"}),e.jsxs(it,{hasGutter:!0,className:"pf-v6-u-align-items-baseline",children:[e.jsx(X,{isFilled:!0,children:e.jsxs(D,{alignItems:{default:"alignItemsCenter"},children:[e.jsx(K,{headingLevel:"h2",className:"pf-v6-u-w-50",children:p?`${R(m,"result")} found`:e.jsx(Ae,{screenreaderText:"Loading cluster vulnerability count"})}),o&&e.jsx(lt,{})]})}),e.jsx(X,{children:e.jsx(ot,{itemCount:m,perPage:x,page:c,onSetPage:(h,C)=>u(C),onPerPageSelect:(h,C)=>{v(C)}})})]}),e.jsx(Bs,{tableState:y,getSortParams:T,onClearFilters:()=>{r({}),u(1)}})]})]})}const Js="ClusterPageDetails",er="ClusterPageVulnerabilities",tr=tt("Platform",{entityTab:"Cluster"}),sr=j`
    ${Is}
...
`;function rr(){var c;const{clusterId:s}=Ye(),{data:t,error:a}=I(sr,{variables:{id:s}}),[n,r]=He("detailsTab",fe),i=fe[0],l=fe[1],o=((c=t==null?void 0:t.cluster)==null?void 0:c.name)??"";return e.jsxs(e.Fragment,{children:[e.jsx(de,{title:`Platform CVEs - Cluster ${o}`}),e.jsx(b,{type:"breadcrumb",children:e.jsxs(Je,{children:[e.jsx(et,{to:tr,children:"Clusters"}),e.jsx(st,{isActive:!0,children:o??e.jsx(Ae,{screenreaderText:"Loading cluster name",width:"200px"})})]})}),a?e.jsx(b,{hasBodyWrapper:!1,children:e.jsx(ve,{children:e.jsx(ct,{title:ut(a),headingLevel:"h2",icon:dt,status:"danger"})})}):e.jsxs(e.Fragment,{children:[e.jsx(b,{hasBodyWrapper:!1,children:e.jsx($s,{data:t==null?void 0:t.cluster})}),e.jsx(b,{type:"tabs",children:e.jsxs(Kt,{activeKey:n,onSelect:(x,u)=>{r(u)},usePageInsets:!0,mountOnEnter:!0,unmountOnExit:!0,children:[e.jsx(Re,{eventKey:i,tabContentId:er,title:i,children:e.jsx(Ys,{clusterId:s})}),e.jsx(Re,{eventKey:l,tabContentId:Js,title:l,children:e.jsx(Os,{clusterId:s})})]})})]})]})}function dr(){const{hasReadAccess:s}=zt(),t=s("Integration");return e.jsxs(e.Fragment,{children:[t&&e.jsx(Qt,{}),e.jsxs(Gt,{children:[e.jsx(H,{index:!0,element:e.jsx(ms,{})}),e.jsx(H,{path:"cves/:cveId",element:e.jsx(Ps,{})}),e.jsx(H,{path:"clusters/:clusterId",element:e.jsx(rr,{})}),e.jsx(H,{path:"*",element:e.jsxs(b,{hasBodyWrapper:!1,children:[e.jsx(de,{title:"Platform CVEs - Not Found"}),e.jsx(Wt,{})]})})]})]})}export{dr as default};
