...
(function () {
  ...
  var FAB = {
    ...
    init: function () {
      ...
      var ICON_EXIT = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M6 0a1 1 0 0 0-1 1v1H2a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h3v1a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1H6zm4 2v12H6V2h4zM2 4h3v1H2v6h3v1H2a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1zm8.854 3.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708-.708L9.793 8H5.5a.5.5 0 0 1 0-1h4.293L8.646 5.854a.5.5 0 1 1 .708-.708l1.5 1.5z"/></svg>';
