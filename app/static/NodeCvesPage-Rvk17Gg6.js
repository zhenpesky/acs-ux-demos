import{ck as re,mb as Q,mc as ie,md as Se,me as Nt,dG as de,eP as be,mf as Ye,mg as Ze,w as e,aG as H,aH as W,a5 as F,mh as Je,mi as Tt,aI as p,mj as ze,mk as Ce,lY as Ft,lZ as Lt,dt as le,l$ as It,m0 as Ot,aJ as X,ax as d,ml as Dt,b9 as ce,mm as ue,m1 as et,m2 as Ee,m3 as tt,bc as Pt,cx as Ve,an as Ne,mn as $t,mo as Y,mp as xe,mq as me,mr as nt,dX as k,bO as Te,eB as At,d7 as st,ms as Rt,cB as Fe,cA as Le,lR as Ie,cC as Oe,jV as qt,mt as De,dH as Pe,mu as wt,bP as _t,kF as kt,kG as Bt,kH as Mt,lT as $e,mv as ot,mw as at,mx as rt,my as Ae,lK as Re,mz as qe,mA as zt,ap as pe,ac as S,aC as B,ad as he,aD as Ue,aj as Ut,bU as Gt,bV as Kt,mB as Qt,aX as Ht,bT as Wt,K as Xt,mC as Yt,mD as Zt,jH as Jt,mE as we,fk as en,mF as M,mG as je,mH as ge,mI as it,mJ as dt,mK as tn,mL as lt,ba as Z,aR as nn,aT as sn,aU as on,bL as an,bp as Ge,bj as ct,mM as ut,bf as xt,bg as mt,mN as pt,bh as ht,ee as _e,mO as rn,bi as K,mP as jt,mQ as oe,mR as gt,e6 as yt,g0 as ae,mS as Ct,cz as ft,mT as dn,ed as ln,a_ as ne,dj as fe,mU as cn,mV as un,mW as xn,bl as ve,bY as vt,cr as St,dU as bt,bm as mn,cn as pn,co as q,cp as w,cq as _,mX as ye,ae as hn,af as Ke,b5 as jn,mY as gn,ch as yn,ci as se,fa as Cn}from"./index-wZHRvX4z.js";import{u as I,g as V,f as fn,r as vn}from"./apollo-BxVF6eGb.js";import{u as Sn,a as bn,b as En,S as Vn,c as Nn,E as Qe}from"./ExpandableLabelSection-DrUkChg5.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-CQrCW_T6.js";const Tn=V`
...
`,Mn=["Component","Type"],zn={field:"Component",direction:"asc"};function Vt({data:n}){const{sortOption:t,getSortParams:s}=Jt({sortFields:Mn,defaultSortOption:zn}),r=Bn(n,t);return n.length===0?null:e.jsxs(H,{children:[e.jsx(W,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(p,{sort:s("Component"),children:"Component"}),e.jsx(p,{children:"Version"}),e.jsx(p,{children:"CVE fixed in"}),e.jsx(p,{sort:s("Type"),children:"Type"})]})}),e.jsx(X,{children:r.map(({name:o,source:a,version:m,nodeVulnerabilities:c})=>{var g;const i=(g=c==null?void 0:c[0])==null?void 0:g.fixedByVersion;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Component",children:o}),e.jsx(d,{dataLabel:"Version",children:m}),e.jsx(d,{dataLabel:"CVE fixed in",children:i||e.jsx(we,{isFixable:!1})}),e.jsx(d,{dataLabel:"Type",children:a})]},o)})})]})}const Un=[Y,M,je,ge,xe,me],Gn={field:M,direction:"desc"},Kn=V`
    ${Et}
