import{cj as re,m8 as G,m9 as ie,ma as Se,mb as Nt,dz as de,eI as be,mc as Ye,md as Xe,w as e,aF as W,aG as H,a4 as F,me as Je,mf as Tt,aH as h,mg as ze,mh as Ce,lV as Ft,lW as Lt,dl as le,lY as It,lZ as Ot,aI as Z,aw as d,mi as Dt,b8 as ce,mj as ue,l_ as et,l$ as Ee,m0 as tt,bb as Pt,cy as Ve,am as Ne,mk as $t,ml as Y,mm as xe,mn as me,mo as nt,dQ as k,bN as Te,eu as At,d8 as st,mp as wt,cC as Fe,cB as Le,lO as Ie,cD as Oe,jS as qt,mq as De,dA as Pe,mr as Rt,bO as _t,kC as kt,kD as Bt,kE as Mt,lQ as $e,ms as ot,mt as at,mu as rt,mv as Ae,lH as we,mw as qe,mx as zt,ao as he,ab as S,aB as B,ac as pe,aC as Qe,ai as Qt,bT as Ut,bU as Kt,my as Gt,aW as Wt,bS as Ht,K as Zt,mz as Yt,mA as Xt,jE as Jt,mB as Re,fg as en,mC as M,mD as je,mE as ge,mF as it,mG as dt,mH as tn,mI as lt,b9 as X,aQ as nn,aS as sn,aT as on,bK as an,bo as Ue,bi as ct,mJ as ut,be as xt,bf as mt,mK as ht,bg as pt,e7 as _e,mL as rn,bh as K,mM as jt,mN as oe,mO as gt,d$ as yt,fY as ae,mP as Ct,cA as ft,mQ as dn,e6 as ln,aZ as ne,df as fe,mR as cn,mS as un,mT as xn,bk as ve,bX as vt,cs as St,cl as bt,bl as mn,co as hn,cp as q,cq as R,cr as _,mU as ye,ad as pn,ae as Ke,b4 as jn,mV as gn,cg as yn,ch as se,f3 as Cn}from"./index-D2I63wLg.js";import{u as I,g as V,f as fn,r as vn}from"./apollo-BxVF6eGb.js";import{u as Sn,a as bn,b as En,S as Vn,c as Nn,E as Ge}from"./ExpandableLabelSection-BrnOH7Zx.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-BazuXrDl.js";const Tn=V`
...
`,Mn=["Component","Type"],zn={field:"Component",direction:"asc"};function Vt({data:n}){const{sortOption:t,getSortParams:s}=Jt({sortFields:Mn,defaultSortOption:zn}),r=Bn(n,t);return n.length===0?null:e.jsxs(W,{children:[e.jsx(H,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(h,{sort:s("Component"),children:"Component"}),e.jsx(h,{children:"Version"}),e.jsx(h,{children:"CVE fixed in"}),e.jsx(h,{sort:s("Type"),children:"Type"})]})}),e.jsx(Z,{children:r.map(({name:o,source:a,version:m,nodeVulnerabilities:c})=>{var g;const i=(g=c==null?void 0:c[0])==null?void 0:g.fixedByVersion;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Component",children:o}),e.jsx(d,{dataLabel:"Version",children:m}),e.jsx(d,{dataLabel:"CVE fixed in",children:i||e.jsx(Re,{isFixable:!1})}),e.jsx(d,{dataLabel:"Type",children:a})]},o)})})]})}const Qn=[Y,M,je,ge,xe,me],Un={field:M,direction:"desc"},Kn=V`
    ${Et}
