import{ck as re,ma as K,mb as ie,mc as Se,md as Nt,dG as de,eP as be,me as Ye,mf as Ze,w as e,aG as H,aH as W,a5 as F,mg as Je,mh as Tt,aI as p,mi as ze,mj as Ce,lX as Ft,lY as Lt,dt as le,l_ as It,l$ as Ot,aJ as X,ax as d,mk as Dt,b9 as ce,ml as ue,m0 as et,m1 as Ee,m2 as tt,bc as Pt,cx as Ve,an as Ne,mm as $t,mn as Y,mo as xe,mp as me,mq as nt,dX as k,bO as Te,eB as At,d7 as st,mr as qt,cB as Fe,cA as Le,lQ as Ie,cC as Oe,jV as wt,ms as De,dH as Pe,mt as Rt,bP as _t,kF as kt,kG as Bt,kH as Mt,lS as $e,mu as ot,mv as at,mw as rt,mx as Ae,lJ as qe,my as we,mz as zt,ap as pe,ac as S,aC as B,ad as he,aD as Ue,aj as Ut,bU as Gt,bV as Qt,mA as Kt,aX as Ht,bT as Wt,K as Xt,mB as Yt,mC as Zt,jH as Jt,mD as Re,fk as en,mE as M,mF as je,mG as ge,mH as it,mI as dt,mJ as tn,mK as lt,ba as Z,aR as nn,aT as sn,aU as on,bL as an,bp as Ge,bj as ct,mL as ut,bf as xt,bg as mt,mM as pt,bh as ht,ee as _e,mN as rn,bi as Q,mO as jt,mP as oe,mQ as gt,e6 as yt,g0 as ae,mR as Ct,cz as ft,mS as dn,ed as ln,a_ as ne,dj as fe,mT as cn,mU as un,mV as xn,bl as ve,bY as vt,cr as St,dU as bt,bm as mn,cn as pn,co as w,cp as R,cq as _,mW as ye,ae as hn,af as Qe,b5 as jn,mX as gn,ch as yn,ci as se,fa as Cn}from"./index-CrjYH59d.js";import{u as I,g as V,f as fn,r as vn}from"./apollo-BxVF6eGb.js";import{u as Sn,a as bn,b as En,S as Vn,c as Nn,E as Ke}from"./ExpandableLabelSection-483_Elet.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-G8Tjzevb.js";const Tn=V`
...
`,Mn=["Component","Type"],zn={field:"Component",direction:"asc"};function Vt({data:n}){const{sortOption:t,getSortParams:s}=Jt({sortFields:Mn,defaultSortOption:zn}),r=Bn(n,t);return n.length===0?null:e.jsxs(H,{children:[e.jsx(W,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(p,{sort:s("Component"),children:"Component"}),e.jsx(p,{children:"Version"}),e.jsx(p,{children:"CVE fixed in"}),e.jsx(p,{sort:s("Type"),children:"Type"})]})}),e.jsx(X,{children:r.map(({name:o,source:a,version:m,nodeVulnerabilities:c})=>{var g;const i=(g=c==null?void 0:c[0])==null?void 0:g.fixedByVersion;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Component",children:o}),e.jsx(d,{dataLabel:"Version",children:m}),e.jsx(d,{dataLabel:"CVE fixed in",children:i||e.jsx(Re,{isFixable:!1})}),e.jsx(d,{dataLabel:"Type",children:a})]},o)})})]})}const Un=[Y,M,je,ge,xe,me],Gn={field:M,direction:"desc"},Qn=V`
    ${Et}
...
`;function gs(n){return I(js,{variables:{id:n}})}function ys({nodeId:n}){const{data:t,loading:s,error:r}=gs(n);return e.jsxs(e.Fragment,{children:[e.jsx(S,{component:"div",children:e.jsx(Ne,{component:"p",children:"View details about this node"})}),e.jsx(Q,{component:"div"}),e.jsx(S,{isFilled:!0,children:r?e.jsx(ve,{children:e.jsx(vt,{title:"There was an error loading the node details",headingLevel:"h2",icon:bt,status:"danger",children:St(r)})}):s?e.jsx(ve,{children:e.jsx(mn,{size:"xl"})}):t&&e.jsxs(B,{direction:{default:"column"},spaceItems:{default:"spaceItemsXl"},children:[e.jsxs(pn,{columnModifier:{default:"1Col",lg:"2Col"},children:[e.jsxs(w,{children:[e.jsx(R,{children:"Cluster"}),e.jsx(_,{children:t.node.cluster.name})]}),t.node.containerRuntimeVersion&&e.jsxs(w,{children:[e.jsx(R,{children:"Container runtime"}),e.jsx(_,{children:t.node.containerRuntimeVersion})]}),t.node.joinedAt&&e.jsxs(w,{children:[e.jsx(R,{children:"Join time"}),e.jsx(_,{children:fe(t.node.joinedAt)})]}),t.node.scanTime&&e.jsxs(w,{children:[e.jsx(R,{children:"Scan time"}),e.jsx(_,{children:fe(t.node.scanTime)})]}),t.node.kernelVersion&&e.jsxs(w,{children:[e.jsx(R,{children:"Kernel version"}),e.jsx(_,{children:t.node.kernelVersion})]}),t.node.kubeletVersion&&e.jsxs(w,{children:[e.jsx(R,{children:"Kubelet"}),e.jsx(_,{children:t.node.kubeletVersion})]})]}),e.jsx(Ke,{toggleText:"Labels",labels:t.node.labels}),e.jsx(Ke,{toggleText:"Annotations",labels:t.node.annotations})]})})]})}const Cs="NodePageDetails",fs="NodePageVulnerabilities",vs=pt("Node",{entityTab:"Node"}),Ss=V`
    ${os}
