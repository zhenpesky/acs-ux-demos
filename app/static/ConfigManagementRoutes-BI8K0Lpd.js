import{da as C,t as D,fc as j,w as e,fw as xn,af as U,b3 as gs,ao as Xe,fx as xs,ff as B,fy as yn,b7 as Re,fq as cs,fb as Nn,f6 as bn,fz as jn,ah as Sn,cr as En,D as be,fA as pt,am as Tn,fk as Rn,fB as yt,fC as Nt,fD as vn,fE as Pn,f1 as te,fs as bt,cw as jt,aq as An,ar as $n,fd as St,fF as In,de as ee,fl as Et,fG as Tt,cE as wn,fH as Rt,fI as On,fJ as Ln,dK as Un,eq as qn,fK as Dn,dj as We,fL as ys,fp as kn,fM as vt,fN as Pt,fr as Ns,eE as Mn,cf as Fn,cg as _}from"./index-Dby161ZL.js";import{r as I,R as us,g as q,u as At}from"./apollo-BxVF6eGb.js";import{s as G,w as De}from"./URLSearchInputWithAutocomplete-B6hcBlwn.js";import{E as $t,D as It,e as ne,m as ds,T as _n,B as Yn,a as Vn,L as ms,c as ps,P as Qe,d as Te,i as Ve,n as He,b as me,p as pe,r as Ge,s as Le,f as Ue,g as Be,h as Hn,j as Gn,k as wt,C as V,M as je,l as Bn,o as Ct,q as Ot,t as Qn,u as Wn,v as Cs,w as Lt,S as Ut,G as Kn}from"./GroupedTabs-DtPcXKfs.js";import{E as bs,d as z,u as zn,a as Jn,S as Xn,C as Zn,B as js,f as ea,e as sa}from"./ControlDetails-dM1Fsy2s.js";import{u as k,U as b,g as H,W as Y,S as qt,b as ta,G as na,a as aa,X as ra,c as oa,M as la,L as ia,Y as ca,e as Ke,i as ae,o as Dt,f as Ss,T as O,p as fe,q as he,r as ge,s as xe,P as kt,t as ua}from"./URLSearchInput-Cak9guHN.js";import{q as w,T as Ze,d as x,a as $,n as M,D as da,b as ma,I as pa,c as Ca,P as fa,K as ha,S as ga,e as xa,f as ya}from"./queryService-CLIpYCCP.js";import{s as Pe,a as ft,p as Na}from"./policy.proto-UGifO4do.js";import{g as ba}from"./mathUtils-DiJFKe7q.js";import{s as Ce}from"./standards-1mis8f04.js";import{N as Z,P as Es,b as Ts,c as Mt,d as Rs,e as vs,f as Ft,h as _t,C as ja,g as Sa}from"./search-Ds_XTM67.js";import{s as Yt}from"./startCase-CKfjyd3h.js";import{r as es}from"./object-resolve-path-esx_DSkd.js";import{s as fs,a as Ea,b as Vt,c as Ta}from"./sorters-DROgS-i8.js";import{P as Ra}from"./PolicyDisabledIconText-_t5RJYck.js";import{P as ss,f as Ps}from"./policies.utils-Ml4LDJ5O.js";import{C as va}from"./CloseButton-BG0hbpuE.js";import{c as Pa}from"./controls-CFAE8uc8.js";import{A as Aa}from"./_baseGt-D5RcsErN.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./searchOptionsToQuery-Q3UHmnOv.js";import"./react-onclickoutside.es-B-GukE-X.js";import"./react-popper-DGwMWsaF.js";import"./popper-U5NbITwx.js";import"./index-C7DaFB0M.js";import"./Progress-C-4ja_PY.js";import"./times-circle-icon-BrJ3WhBu.js";import"./d3-D72bN1z7.js";import"./check-circle-CFomXJmh.js";import"./_createCompounder-BcIcWh_L.js";import"./omit-BKo0vp7k.js";import"./_flatRest-Bo0JQNEb.js";import"./TableCellValue-1IwASu0s.js";import"./set-D1vJ8gzf.js";import"./_baseSet-yznxV2et.js";function hs(){return hs=Object.assign||function(s){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var o in a)Object.prototype.hasOwnProperty.call(a,o)&&(s[o]=a[o])}return s},hs.apply(this,arguments)}function $a(s,t){if(s==null)return{};var a=Ia(s,t),o,n;if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(s);for(n=0;n<r.length;n++)o=r[n],!(t.indexOf(o)>=0)&&Object.prototype.propertyIsEnumerable.call(s,o)&&(a[o]=s[o])}return a}function Ia(s,t){if(s==null)return{};var a={},o=Object.keys(s),n,r;for(r=0;r<o.length;r++)n=o[r],!(t.indexOf(n)>=0)&&(a[n]=s[n]);return a}var As=I.forwardRef(function(s,t){var a=s.color,o=a===void 0?"currentColor":a,n=s.size,r=n===void 0?24:n,l=$a(s,["color","size"]);return us.createElement("svg",hs({ref:t,xmlns:"http://www.w3.org/2000/svg",width:r,height:r,viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},l),us.createElement("line",{x1:"5",y1:"12",x2:"19",y2:"12"}),us.createElement("polyline",{points:"12 5 19 12 12 19"}))});As.propTypes={color:C.string,size:C.oneOfType([C.string,C.number])};As.displayName="ArrowRight";const wa=q`
...
`;function Ha(s,t){const a=ds(t[s].filter(n=>!n.passing).map(n=>ft[n.severity])),o=Object.entries(ft).find(n=>n[1]===a);return o?xs[o[0]]:Gt}const Ga=()=>{const s=k(),t=D(),a=I.useContext(G),o=i=>!i||!i.policies||!i.policies.length?[]:i.policies;function n(i){const u=i.reduce((c,d)=>{const{categories:m,severity:p,name:f}=d,h=d.policyStatus.toLowerCase()===Oe.PASS.toLowerCase(),g={...c};return m.forEach((y,N)=>{g[y]||(g[y]=[]);const S=h?Gt:xs[p],P=h?null:{[a]:{[z.POLICY_STATUS.CATEGORY]:Oe.FAIL}},R=b.getURL(s,t).base(j.POLICY,d.id).push(j.DEPLOYMENT).query(P).url(),A=N>0?`${N}. ${f}`:f;g[y].push({severity:p,passing:h,color:S,value:0,labelColor:S,name:`${h?"":"View deployments violating"} "${A}"`,link:R})}),g},{});return Object.entries(u).map(c=>{const d=c[0],m=c[1],p=m.filter(y=>y.passing).length,f=`${m.length-p}/${m.length} policies violated`,h=ba(p,m.length),g=Ha(d,u);return{name:d,children:m,value:h,labelValue:f,color:g}})}function r(i){return i.filter(c=>c.policyStatus.toLowerCase()==="fail").length}function l(i){const u=i.filter(N=>N.policyStatus==="fail");function c(N){return u.filter(S=>S.severity===N).length}const d=c(Pe.CRITICAL_SEVERITY),m=c(Pe.HIGH_SEVERITY),p=c(Pe.MEDIUM_SEVERITY),f=c(Pe.LOW_SEVERITY),h=i.filter(N=>!N.disabled).length-u.length,g=[],y=b.getURL(s,t).base(j.POLICY);return d&&g.push({text:`${d} rated as critical`,link:y.query({[a]:{Severity:Pe.CRITICAL_SEVERITY,[z.POLICY_STATUS.CATEGORY]:Oe.FAIL}}).url()}),y.query(null),m&&g.push({text:`${m} rated as high`,link:y.query({[a]:{Severity:Pe.HIGH_SEVERITY,Disabled:"False",[z.POLICY_STATUS.CATEGORY]:Oe.FAIL}}).url()}),y.query(null),p&&g.push({text:`${p} rated as medium`,link:y.query({[a]:{Severity:Pe.MEDIUM_SEVERITY,Disabled:"False",[z.POLICY_STATUS.CATEGORY]:Oe.FAIL}}).url()}),y.query(null),f&&g.push({text:`${f} rated as low`,link:y.query({[a]:{Severity:Pe.LOW_SEVERITY,Disabled:"False",[z.POLICY_STATUS.CATEGORY]:Oe.FAIL}}).url()}),y.query(null),h&&g.push({text:`${h} policies without violations`,link:y.query({[a]:{Disabled:"False",[z.POLICY_STATUS.CATEGORY]:Oe.PASS}}).url()}),g}return e.jsx(H,{query:Va,fetchPolicy:"network-only",variables:{query:"LifeCycle Stage:DEPLOY"},children:({loading:i,data:u,networkStatus:c})=>{let d=e.jsx(B,{}),m=null;if(!i&&u&&c===$s.READY){const p=o(u),f=n(p),h=r(p),g=l(p),y=b.getURL(s,t).base(j.POLICY).url();m=e.jsx(Re,{to:y,className:"no-underline btn-sm btn-base",children:"View all"}),f.length?d=e.jsx(qt,{data:f,rootData:g,legendData:Ya,totalValue:h,units:"value"}):d=e.jsx("div",{className:"flex flex-1 items-center justify-center p-4 leading-loose",children:"No data available."})}return e.jsx(Y,{className:"s-2 pdf-page",header:"Policy violations by severity",headerComponents:m,children:d})}})},J={PASS:"Pass",FAIL:"Fail","N/A":"N/A"},Bt=bn,Qt=jn,Wt="var(--base-400)",Ba=[{title:"Passing",color:Bt},{title:"Failing",color:Qt},{title:"N/A",color:Wt}],Kt=q`
...
`,ke=({header:s,isCollapsible:t,children:a,isCollapsibleOpen:o,hasTitleBorder:n})=>{const[r,l]=I.useState(o);function i(){t&&l(c=>!c)}const u={opened:e.jsx(ja,{className:`bg-base-200 border border-base-400 mr-4 rounded-full ${t?"":"invisible"}`,size:"14"}),closed:e.jsx(_t,{className:`bg-base-200 border border-base-400 mr-4 rounded-full ${t?"":"invisible"}`,size:"14"})};return e.jsxs("div",{className:`${n?"border-b":""} border-base-300 w-full`,children:[e.jsx("button",{type:"button",className:`flex flex-1 w-full ${t?"cursor-pointer hover:bg-primary-100":"cursor-auto"}`,onClick:i,children:e.jsxs("div",{className:`flex w-full p-3 ${r?"border-b border-base-300":""}`,children:[u[r?"opened":"closed"],s]})}),e.jsx(On,{isOpen:r,children:a})]})};ke.propTypes={header:C.node.isRequired,isCollapsible:C.bool,children:C.node.isRequired,isCollapsibleOpen:C.bool,hasTitleBorder:C.bool};ke.defaultProps={isCollapsible:!0,isCollapsibleOpen:!0,hasTitleBorder:!0};const Yr=s=>{const{violations:t}=s;if(!t||!t.length)return[];const a=t.reduce((o,n)=>{const{deployment:r,time:l,policy:i}=n,u=o[i.id]?o[i.id].deployments:[];return o[i.id]={...i,deployments:[...u,{time:l,...r}]},o},{});return Object.values(a)},Vs=({original:s,entityContext:t})=>{const{deployments:a}=s,o=wt[j.DEPLOYMENT](t),n=be(),r=D(),l=k();function i(u){const c=es(u,"id"),d=b.getURL(l,r).push(j.DEPLOYMENT,c).url();n(d)}return e.jsx(Ze,{rows:a,columns:o,onRowClick:i,idAttribute:"id",noDataText:"No results found. Please refine your search."})};Vs.propTypes={original:C.shape({deployments:C.arrayOf(C.shape({}))}).isRequired,entityContext:C.shape({})};Vs.defaultProps={entityContext:{}};const as=({query:s,message:t,entityContext:a})=>e.jsx(H,{query:_r,variables:{query:s},children:({loading:o,data:n})=>{if(o)return e.jsx(B,{});if(!n)return null;const r=Yr(n),l=Et(n.violations.map(c=>c.deployment)).length;if(l===0)return e.jsx(Z,{message:t,className:"p-3 shadow",icon:"info"});const i=`${l} deployments failed across ${r.length} policies`,u=[{Header:"Policy",headerClassName:$,className:x,accessor:"name",Cell:({original:c,pdf:d})=>{const{severity:m,categories:p,name:f}=c,h=e.jsxs("div",{className:"flex flex-1",children:[e.jsx("div",{className:"flex flex-1",children:f}),e.jsxs("div",{children:[e.jsxs("span",{children:["Severity:"," ",e.jsx(ss,{severity:m,isTextOnly:d})]}),e.jsx("span",{className:"pl-2 pr-2",children:"|"}),e.jsxs("span",{children:["Categories: ",p.join(",")]})]})]});return e.jsx(ke,{header:h,isCollapsibleOpen:!1,className:"z-20",hasTitleBorder:!1,children:e.jsx(Vs,{original:c,entityContext:a})},f)}}];return e.jsx(Ie,{header:i,rows:r,noDataText:"No deployments failing across policies",className:"w-full",columns:u,idAttribute:"id",id:"deployments-with-failed-policies",hasNestedTable:!0})}});as.propTypes={query:C.string,message:C.string,entityContext:C.shape({})};as.defaultProps={query:"",message:"",entityContext:{}};function Vr(s){return s===j.SERVICE_ACCOUNT?"serviceAccounts":s===j.ROLE?"k8sRoles":U(s.toLowerCase())}function we(s,t){if(!s||!t)return[];const a=Vr(t);return s[a]??[]}const Hs=({id:s,entityListType:t,entityId1:a,query:o,entityContext:n,pagination:r})=>{const l=I.useContext(G),i={...o[l]};t==="POLICY"&&(i["Lifecycle Stage"]="DEPLOY"),!i.Standard&&t==="CONTROL"&&(i.Standard="CIS");const u={id:s,query:w.objectToWhereClause(i),pagination:r},c=q`
    ...
    `;function d(){if(!t)return c;const{listFieldName:m,fragmentName:p,fragment:f}=w.getFragmentInfo("CLUSTER",t,"configmanagement"),h=$e(t);return q`
...
`,Kr=s=>{const t=[];return s.violations.reduce((o,n)=>{const r={time:n.time,...n.policy};return[...o,r]},t)};function zr({deploymentID:s}){return s?e.jsx(H,{query:Wr,variables:{query:w.objectToWhereClause({"Deployment ID":s,"Lifecycle Stage":"DEPLOY"})},children:({loading:t,data:a})=>{if(t)return e.jsx(B,{});if(!a)return null;const o=Kr(a);if(o.length===0)return e.jsx(Z,{message:"No policies failed across this deployment",className:"p-3 shadow",icon:"info"});const n=`${o.length} policies failed across this deployment`,r=[{Header:"Id",headerClassName:"hidden",className:"hidden",accessor:"id"},{Header:"Policy",headerClassName:`w-1/5 ${$}`,className:`w-1/5 ${x}`,accessor:"name"},{Header:"Enforcing",headerClassName:`w-1/8 ${$}`,className:`w-1/8 ${x}`,Cell:({original:l})=>{const{enforcementActions:i}=l;return(i??[]).length>0?"Yes":"No"},accessor:"enforcementActions"},{Header:"Severity",headerClassName:`w-1/8 ${$}`,className:`w-1/8 ${x}`,Cell:({original:l,pdf:i})=>{const{severity:u}=l;return e.jsx(ss,{severity:u,isTextOnly:i})},accessor:"severity",sortMethod:Vt},{Header:"Categories",headerClassName:`w-1/5 ${$}`,className:`w-1/5 ${x}`,Cell:({original:l})=>{const{categories:i}=l;return i.join(", ")},accessor:"categories"},{Header:"Lifecycle Stage",headerClassName:`w-1/8 ${$}`,className:`w-1/8 ${x}`,Cell:({original:l})=>{const{lifecycleStages:i}=l;return Ps(i)},accessor:"lifecycleStages"},{Header:"Violation Time",headerClassName:`w-1/8 ${$}`,className:`w-1/8 ${x}`,Cell:({original:l})=>ee(l.time),accessor:"time"}];return e.jsx(Ie,{entityType:j.POLICY,header:n,rows:o,columns:r,className:"bg-base-100 w-full",idAttribute:"id",noDataText:"No failed policies."})}}):e.jsx(Ln,{error:new Error("Unable to show failed policies for this deployment."),message:"A required ID for this deployment was not provided!"})}function Jr({entityContext:s={},deploymentID:t}){return s[j.POLICY]?e.jsx(Bs,{deploymentID:t,policyID:s[j.POLICY],message:"No policies failed across this deployment"}):e.jsx("div",{className:"mx-4 w-full",children:e.jsx(zr,{deploymentID:t})})}const Qs=({id:s,entityContext:t,entityListType:a,query:o,pagination:n})=>{const r=I.useContext(G),l={id:s,query:w.objectToWhereClause(o[r]),pagination:n},i=q`
    ...
    `;function d(){if(!t)return c;const{listFieldName:m,fragmentName:p,fragment:f}=w.getFragmentInfo("IMAGE",t,"configmanagement"),h=$e(t);return q`
    ...
    `;function c(){if(!t)return u;const{listFieldName:d,fragmentName:m,fragment:p}=w.getFragmentInfo("NAMESPACE",t,"configmanagement"),f=$e(t);return q`
    ...
    `;function c(){if(!t)return u;const{listFieldName:d,fragmentName:m,fragment:p}=w.getFragmentInfo("ROLE",t,"configmanagement"),f=$e(t);return q`
    ...
    `;function c(){if(!t)return u;const{listFieldName:d,fragmentName:m,fragment:p}=w.getFragmentInfo("SECRET",t,"configmanagement"),f=$e(t);return q`
    ...
    `;function c(){if(!t)return u;const{listFieldName:d,fragmentName:m,fragment:p}=w.getFragmentInfo("SERVICE_ACCOUNT",t,"configmanagement"),f=$e(t);return q`
