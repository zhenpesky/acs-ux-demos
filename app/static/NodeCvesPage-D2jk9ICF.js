import{ck as re,m9 as G,ma as ie,mb as Se,mc as Nt,dz as de,eI as be,md as Xe,me as Ye,w as e,aG as W,aH as H,a5 as F,mf as Je,mg as Tt,aI as p,mh as ze,mi as Ce,lW as Ft,lX as Lt,dl as le,lZ as It,l_ as Ot,aJ as Z,ax as d,mj as Dt,b9 as ce,mk as ue,l$ as et,m0 as Ee,m1 as tt,bc as Pt,cx as Ve,an as Ne,ml as $t,mm as X,mn as xe,mo as me,mp as nt,dQ as k,bO as Te,eu as At,d7 as st,mq as Rt,cB as Fe,cA as Le,lP as Ie,cC as Oe,jT as qt,mr as De,dA as Pe,ms as wt,bP as _t,kD as kt,kE as Bt,kF as Mt,lR as $e,mt as ot,mu as at,mv as rt,mw as Ae,lI as Re,mx as qe,my as zt,ap as pe,ac as S,aC as B,ad as he,aD as Ue,aj as Ut,bU as Qt,bV as Kt,mz as Gt,aX as Wt,bT as Ht,K as Zt,mA as Xt,mB as Yt,jF as Jt,mC as we,fg as en,mD as M,mE as je,mF as ge,mG as it,mH as dt,mI as tn,mJ as lt,ba as Y,aR as nn,aT as sn,aU as on,bL as an,bp as Qe,bj as ct,mK as ut,bf as xt,bg as mt,mL as pt,bh as ht,e7 as _e,mM as rn,bi as K,mN as jt,mO as oe,mP as gt,d$ as yt,fY as ae,mQ as Ct,cz as ft,mR as dn,e6 as ln,a_ as ne,df as fe,mS as cn,mT as un,mU as xn,bl as ve,bY as vt,cr as St,dN as bt,bm as mn,cn as pn,co as q,cp as w,cq as _,mV as ye,ae as hn,af as Ke,b5 as jn,mW as gn,ch as yn,ci as se,f3 as Cn}from"./index-HXcpGjZs.js";import{u as I,g as V,f as fn,r as vn}from"./apollo-BxVF6eGb.js";import{u as Sn,a as bn,b as En,S as Vn,c as Nn,E as Ge}from"./ExpandableLabelSection-BGx1q-Pq.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-jcRJ0oiX.js";const Tn=V`
...
`,Mn=["Component","Type"],zn={field:"Component",direction:"asc"};function Vt({data:n}){const{sortOption:t,getSortParams:s}=Jt({sortFields:Mn,defaultSortOption:zn}),r=Bn(n,t);return n.length===0?null:e.jsxs(W,{children:[e.jsx(H,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(p,{sort:s("Component"),children:"Component"}),e.jsx(p,{children:"Version"}),e.jsx(p,{children:"CVE fixed in"}),e.jsx(p,{sort:s("Type"),children:"Type"})]})}),e.jsx(Z,{children:r.map(({name:o,source:a,version:m,nodeVulnerabilities:c})=>{var g;const i=(g=c==null?void 0:c[0])==null?void 0:g.fixedByVersion;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Component",children:o}),e.jsx(d,{dataLabel:"Version",children:m}),e.jsx(d,{dataLabel:"CVE fixed in",children:i||e.jsx(we,{isFixable:!1})}),e.jsx(d,{dataLabel:"Type",children:a})]},o)})})]})}const Un=[X,M,je,ge,xe,me],Qn={field:M,direction:"desc"},Kn=V`
    ${Et}
...
`;function es(n,t){const s=I(Jn,{variables:{cve:n,query:t}}),{data:r,previousData:o}=s,a=(r==null?void 0:r.nodeCount)??(o==null?void 0:o.nodeCount)??0;return{summaryDataRequest:s,nodeCount:a}}const ts=pt("Node",{entityTab:"CVE"}),ns=[ot,rt,Ae],Ze={affectedNodeCountBySeverity:{critical:{total:0},important:{total:0},moderate:{total:0},low:{total:0},unknown:{total:0}},distroTuples:[]};function ss(){const{analyticsTrack:n}=Te(),t=Re(n),{searchFilter:s,setSearchFilter:r}=Fe(),o=De(s),{cveId:a}=ct(),m=`^${a}$`,c=G({...o,CVE:[m]}),{page:i,perPage:g,setPage:x,setPerPage:y}=Le(Ie),{sortOption:j,getSortParams:C}=Oe({sortFields:Un,defaultSortOption:Qn,onSort:()=>x(1)}),b=Pe(o),f=ut(o),{metadataRequest:l,cveData:v}=Yn(a),{summaryDataRequest:T,nodeCount:E}=es(a,c),{affectedNodesRequest:O,nodeData:D}=Zn({query:c,page:i,perPage:g,sortOption:j}),N=v==null?void 0:v.cve,L=de({isLoading:O.loading,error:O.error,data:D,searchFilter:o});return e.jsxs(e.Fragment,{children:[e.jsx(pe,{title:`Node CVEs - NodeCVE ${N}`}),e.jsx(S,{type:"breadcrumb",children:e.jsxs(xt,{children:[e.jsx(mt,{to:ts,children:"Node CVEs"}),e.jsx(ht,{isActive:!0,children:N??e.jsx(_e,{screenreaderText:"Loading CVE name",width:"200px"})})]})}),e.jsx(S,{children:e.jsx(rn,{data:v})}),e.jsx(K,{component:"div"}),e.jsxs(S,{hasBodyWrapper:!1,children:[e.jsx($e,{searchFilter:s,searchFilterConfig:ns,defaultSearchFilterEntity:"Node",onFilterChange:(u,h)=>{r(u),x(1,"replace"),t(qe,h)}}),e.jsxs(jt,{error:l.error,isLoading:l.loading,children:[e.jsx(oe,{data:T.data,loadingText:"Loading affected nodes summary",renderer:({data:u})=>e.jsx(Wn,{affectedNodeCount:E,totalNodeCount:u.totalNodeCount,operatingSystemCount:(u.nodeCVE??Ze).distroTuples.length})}),e.jsx(oe,{data:T.data,loadingText:"Loading affected nodes by CVE severity summary",renderer:({data:u})=>e.jsx(gt,{title:"Nodes by severity",severityCounts:(u.nodeCVE??Ze).affectedNodeCountBySeverity,hiddenSeverities:f})})]}),e.jsx(K,{component:"div"}),e.jsxs(yt,{hasGutter:!0,className:"pf-v6-u-align-items-baseline",children:[e.jsx(ae,{isFilled:!0,children:e.jsxs(B,{alignItems:{default:"alignItemsCenter"},children:[e.jsxs(he,{headingLevel:"h2",children:[Y(E,"node")," affected"]}),b&&e.jsx(Ct,{})]})}),e.jsx(ae,{children:e.jsx(ft,{itemCount:E,perPage:g,page:i,onSetPage:(u,h)=>x(h),onPerPageSelect:(u,h)=>{y(h)}})})]}),e.jsx(Gn,{tableState:L,getSortParams:C,onClearFilters:()=>{r({}),x(1)}})]})]})}const os=V`
