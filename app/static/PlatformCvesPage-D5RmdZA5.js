import{mp as B,n2 as ke,n3 as Y,n4 as J,ck as ee,mb as te,dG as se,w as e,aG as re,aH as ae,a5 as D,aI as f,mk as Me,dt as ne,aJ as ie,ax as d,b9 as le,n5 as oe,ba as _,n6 as Ee,mc as ce,n7 as ue,mH as N,eP as Ue,mh as Ke,mi as jt,mj as gt,ml as bt,mE as Se,n8 as ze,m2 as Ge,bc as vt,cx as Qe,an as R,mn as He,bO as Te,d7 as We,n9 as Et,cB as Ve,cA as Fe,lR as Pe,cC as Le,jV as St,mt as Ie,dH as De,mu as Tt,kF as Vt,kG as Ft,kH as Pt,lT as $e,mv as Xe,na as Ze,lK as qe,nb as Oe,mA as Lt,ap as de,ac as b,aC as $,ad as K,aD as je,mB as It,aX as Dt,bT as $t,K as qt,nc as Ot,mD as At,mJ as Rt,dX as _t,aR as pe,aT as xe,aU as me,bL as ge,bp as U,bj as Ye,bf as Je,bg as et,mN as tt,bh as st,ee as Ae,ed as rt,a_ as be,dj as Re,bU as Bt,mT as at,bi as z,mP as nt,mQ as X,e6 as it,g0 as Z,mS as lt,cz as ot,bl as ve,bY as ct,cr as ut,dU as dt,bm as Nt,cn as wt,co as G,cp as Q,cq as H,nd as pt,ec as kt,fL as Mt,eb as Ut,mV as Kt,mX as fe,ae as zt,af as _e,b5 as Gt,mY as Qt,ch as Ht,ci as W,fa as Wt}from"./index-CHUn_nq_.js";import{u as I,g as j,f as Xt,r as Zt}from"./apollo-BxVF6eGb.js";import{u as Yt,a as Jt,b as es,S as ts,c as ss,E as rs}from"./ExpandableLabelSection-BcVLDFVs.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-BgOJRssC.js";const as=j`
...
`;function ks({clusterId:s,query:t,...a}){return I(ws,{variables:{id:s,query:t,pagination:ee(a)}})}const Ms="var(--pf-t--global--text--color--disabled)",Us=[{status:"Fixable",Icon:kt,text:({fixable:s})=>`${_(s,"vulnerability","vulnerabilities")} with available fixes`},{status:"Not fixable",Icon:Mt,text:({total:s,fixable:t})=>`${_(s-t,"vulnerability","vulnerabilities")} without fixes`}],Ks={Fixable:"Fixable hidden","Not fixable":"Not fixable hidden"},zs=j`
    fragment PlatformCveCountByStatusFragment on PlatformCVECountByFixability {
        total
        fixable
    }
`;function Gs({data:s,hiddenStatuses:t}){return e.jsxs(pe,{isCompact:!0,isFullHeight:!0,children:[e.jsx(xe,{children:"CVEs by status"}),e.jsx(me,{children:e.jsx($,{direction:{default:"column"},children:Us.map(({status:a,Icon:n,text:r})=>{const i=t.has(a);return e.jsxs($,{spaceItems:{default:"spaceItemsSm"},alignItems:{default:"alignItemsCenter"},children:[e.jsx(n,{}),e.jsx(R,{component:"p",style:{color:i?Ms:"inherit"},children:i?Ks[a]:r(s)})]},a)})})})]})}const Qs=[{type:"OpenShift CVE",field:"openshift"},{type:"Kubernetes CVE",field:"kubernetes"},{type:"Istio CVE",field:"istio"}],Hs=j`
    fragment PlatformCveCountByTypeFragment on PlatformCVECountByType {
        kubernetes
        openshift
        istio
    }
`;function Ws({data:s}){return e.jsxs(pe,{isCompact:!0,isFullHeight:!0,children:[e.jsx(xe,{children:"CVEs by type"}),e.jsx(me,{children:e.jsx($,{direction:{default:"column"},children:Qs.map(({type:t,field:a})=>e.jsx(je,{span:12,children:e.jsx(R,{component:"p",children:_(s[a],t)})},t))})})]})}const Xs=j`
    ${zs}
    ${Hs}
...
`;function ar(){var c;const{clusterId:s}=Ye(),{data:t,error:a}=I(rr,{variables:{id:s}}),[n,r]=We("detailsTab",fe),i=fe[0],l=fe[1],o=((c=t==null?void 0:t.cluster)==null?void 0:c.name)??"";return e.jsxs(e.Fragment,{children:[e.jsx(de,{title:`Platform CVEs - Cluster ${o}`}),e.jsx(b,{type:"breadcrumb",children:e.jsxs(Je,{children:[e.jsx(et,{to:sr,children:"Clusters"}),e.jsx(st,{isActive:!0,children:o??e.jsx(Ae,{screenreaderText:"Loading cluster name",width:"200px"})})]})}),a?e.jsx(b,{hasBodyWrapper:!1,children:e.jsx(ve,{children:e.jsx(ct,{title:ut(a),headingLevel:"h2",icon:dt,status:"danger"})})}):e.jsxs(e.Fragment,{children:[e.jsx(b,{hasBodyWrapper:!1,children:e.jsx($s,{data:t==null?void 0:t.cluster})}),e.jsx(b,{type:"tabs",children:e.jsxs(zt,{activeKey:n,onSelect:(p,u)=>{r(u)},usePageInsets:!0,mountOnEnter:!0,unmountOnExit:!0,children:[e.jsx(_e,{eventKey:i,tabContentId:tr,title:i,children:e.jsx(Js,{clusterId:s})}),e.jsx(_e,{eventKey:l,tabContentId:er,title:l,children:e.jsx(As,{clusterId:s})})]})})]})]})}function pr(){const{hasReadAccess:s}=Gt(),t=s("Integration");return e.jsxs(e.Fragment,{children:[t&&e.jsx(Qt,{}),e.jsxs(Ht,{children:[e.jsx(W,{index:!0,element:e.jsx(Cs,{})}),e.jsx(W,{path:"cves/:cveId",element:e.jsx(Is,{})}),e.jsx(W,{path:"clusters/:clusterId",element:e.jsx(ar,{})}),e.jsx(W,{path:"*",element:e.jsxs(b,{hasBodyWrapper:!1,children:[e.jsx(de,{title:"Platform CVEs - Not Found"}),e.jsx(Wt,{})]})})]})]})}export{pr as default};
