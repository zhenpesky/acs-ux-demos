import{cc as re,lV as G,lW as ie,lX as Se,lY as Nt,ds as de,eA as be,lZ as Xe,l_ as Ye,w as e,az as H,aA as W,Z as F,l$ as Je,m0 as Tt,aB as m,m1 as ze,m2 as Ce,lG as Ft,lH as Lt,de as le,lJ as It,lK as Ot,aC as Z,aq as i,m3 as Dt,b1 as ce,m4 as ue,lL as et,lM as Ee,lN as tt,b4 as Pt,cr as Ve,ag as Ne,m5 as $t,m6 as X,m7 as xe,m8 as me,m9 as nt,dI as k,bG as Te,em as wt,d1 as st,ma as qt,cv as Fe,cu as Le,lz as Ie,cw as Oe,mb as De,dt as Pe,mc as At,bH as Rt,kl as _t,km as kt,kn as Bt,lB as $e,md as ot,me as at,mf as rt,mg as we,ls as qe,mh as Ae,mi as Mt,ai as he,a5 as S,av as B,a6 as pe,aw as Ke,ac as zt,bM as Kt,bN as Qt,mj as Ut,aP as Gt,bL as Ht,K as Wt,mk as Zt,ml as Xt,jv as Yt,mm as Re,f8 as Jt,mn as M,mo as je,mp as ge,mq as it,mr as dt,ms as en,mt as lt,b2 as Y,aK as tn,aL as nn,aM as sn,bD as on,bh as Qe,bb as ct,mu as ut,b7 as xt,b8 as mt,mv as ht,b9 as pt,d$ as _e,mw as an,ba as U,mx as jt,my as oe,mz as gt,dT as yt,fQ as ae,mA as Ct,ct as ft,mB as rn,d_ as dn,aS as ne,d8 as fe,mC as ln,mD as cn,mE as un,bd as ve,bQ as vt,cl as St,ce as bt,be as xn,ch as mn,ci as A,cj as R,ck as _,mF as ye,a7 as hn,a8 as Ue,aZ as pn,mG as jn,c9 as gn,ca as se,eX as yn}from"./index-B4SzKVNU.js";import{u as I,g as V,f as Cn,r as fn}from"./apollo-BxVF6eGb.js";import{u as vn,a as Sn,b as bn,S as En,c as Vn,E as Ge}from"./ExpandableLabelSection-CYXA69L0.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-0hPbd246.js";const Nn=V`
...
`,Bn=["Component","Type"],Mn={field:"Component",direction:"asc"};function Vt({data:n}){const{sortOption:t,getSortParams:s}=Yt({sortFields:Bn,defaultSortOption:Mn}),r=kn(n,t);return n.length===0?null:e.jsxs(H,{children:[e.jsx(W,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(m,{sort:s("Component"),children:"Component"}),e.jsx(m,{children:"Version"}),e.jsx(m,{children:"CVE fixed in"}),e.jsx(m,{sort:s("Type"),children:"Type"})]})}),e.jsx(Z,{children:r.map(({name:o,source:a,version:h,nodeVulnerabilities:u})=>{var g;const d=(g=u==null?void 0:u[0])==null?void 0:g.fixedByVersion;return e.jsxs(F,{children:[e.jsx(i,{dataLabel:"Component",children:o}),e.jsx(i,{dataLabel:"Version",children:h}),e.jsx(i,{dataLabel:"CVE fixed in",children:d||e.jsx(Re,{isFixable:!1})}),e.jsx(i,{dataLabel:"Type",children:a})]},o)})})]})}const zn=[X,M,je,ge,xe,me],Kn={field:M,direction:"desc"},Qn=V`
    ${Et}
...
`;function Wn({query:n,...t}){var r,o;const s=I(Hn,{variables:{query:n,pagination:re(t)}});return{affectedNodesRequest:s,nodeData:((r=s.data)==null?void 0:r.nodes)??((o=s.previousData)==null?void 0:o.nodes)}}const Zn=V`
