import{r as I,a as cs,j as e}from"./react-Dz5erZcn.js";import{K as ds,A as yt,C as Nt,x as bt,c as xn,E as We,J as jt,a as yn}from"./lodash-DTYsuwI9.js";import{cq as Nn,G as gs,B as Ze,cr as xs,cn as B,ci as bn,cs as jn,aC as Sn,z as En,ct as St,cu as Et,ch as te,aD as Tt,cv as Rt,cw as Tn,cx as Rn,bT as vn,cy as ys,cz as vt,cA as Pt,cp as Ns}from"./index-CTlcD22L.js";import{s as G,w as De}from"./URLSearchInputWithAutocomplete-Dpko4tDA.js";import{u as D,eG as j,cm as U,bo as Pn,$ as Re,eK as us,eF as An,bh as $n,L as be,dB as pt,eI as In,aT as wn,a7 as On,eM as Xe,eL as At,bQ as Ln,ak as Un,dq as qn,s as ee,eN as bs,b as Dn,ch as kn,Z as Mn,cY as Fn,cZ as _}from"./policy-filters-step-B4IHG4xr.js";import{E as $t,D as It,e as ne,T as _n,B as Yn,a as Vn,L as ms,c as ps,P as Qe,d as Te,i as Ve,n as He,b as me,p as pe,r as Ge,s as Le,f as Ue,g as Be,h as Hn,j as Gn,k as wt,C as V,M as je,l as Bn,m as Ct,o as Ot,q as Qn,t as Wn,u as Cs,v as Lt,S as Ut,G as Kn}from"./GroupedTabs-BnKlBTBh.js";import{E as js,d as z,u as zn,a as Jn,S as Zn,C as Xn,B as Ss,f as ea,e as sa}from"./ControlDetails-CuY5cBNp.js";import{P as C,h as q,u as qt}from"./apollo-DfQf4W16.js";import{u as k,U as b,g as H,W as Y,S as Dt,b as ta,G as na,a as aa,X as ra,c as oa,M as la,L as ia,Y as ca,e as Ke,i as ae,o as kt,f as Es,T as O,p as he,q as fe,r as ge,s as xe,P as Mt,t as ua}from"./URLSearchInput-Bn6QJjfm.js";import{q as w,T as es,d as x,a as $,n as M,D as da,b as ma,I as pa,c as Ca,P as ha,K as fa,S as ga,e as xa,f as ya}from"./queryService-2ebSHDx_.js";import{s as Pe,a as ht,p as Na}from"./policy.proto-UGifO4do.js";import{g as ba}from"./mathUtils-DiJFKe7q.js";import{s as Ce}from"./standards-qR4jfvpP.js";import{N as X,P as Ts,b as Rs,c as Ft,d as vs,e as Ps,f as _t,h as Yt,C as ja,g as Sa}from"./search-lMCPialo.js";import{s as hs,a as Ea,b as Vt,c as Ta}from"./sorters-DROgS-i8.js";import{P as Ra}from"./PolicyDisabledIconText-BYX_z59U.js";import{P as ss}from"./PolicySeverityIconText-DXeFKhLW.js";import{C as va}from"./CloseButton-dpBuclNQ.js";import{c as Pa}from"./controls-C_C6DZR_.js";import{A as Aa}from"./Menu-CGZOc_YM.js";import"./searchOptionsToQuery-Q3UHmnOv.js";import"./react-onclickoutside.es-CvueA9Ge.js";import"./react-popper-BM5jCX-T.js";import"./popper-U5NbITwx.js";import"./index-CBm3v2ee.js";import"./d3-BqOaJXhr.js";import"./check-circle-87emI9ee.js";function fs(){return fs=Object.assign||function(s){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var o in a)Object.prototype.hasOwnProperty.call(a,o)&&(s[o]=a[o])}return s},fs.apply(this,arguments)}function $a(s,t){if(s==null)return{};var a=Ia(s,t),o,n;if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(s);for(n=0;n<r.length;n++)o=r[n],!(t.indexOf(o)>=0)&&Object.prototype.propertyIsEnumerable.call(s,o)&&(a[o]=s[o])}return a}function Ia(s,t){if(s==null)return{};var a={},o=Object.keys(s),n,r;for(r=0;r<o.length;r++)n=o[r],!(t.indexOf(n)>=0)&&(a[n]=s[n]);return a}var As=I.forwardRef(function(s,t){var a=s.color,o=a===void 0?"currentColor":a,n=s.size,r=n===void 0?24:n,l=$a(s,["color","size"]);return cs.createElement("svg",fs({ref:t,xmlns:"http://www.w3.org/2000/svg",width:r,height:r,viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},l),cs.createElement("line",{x1:"5",y1:"12",x2:"19",y2:"12"}),cs.createElement("polyline",{points:"12 5 19 12 12 19"}))});As.propTypes={color:C.string,size:C.oneOfType([C.string,C.number])};As.displayName="ArrowRight";const wa=q`
...
`,Ua=()=>{const{loading:s,error:t,data:a}=qt(La);t&&Nn(t);const o=k(),n=D(),r=b.getURL(o,n).base(j.CONTROL).url(),l=(a==null?void 0:a.executedControlCount)||0;return e.jsx($t,{count:l,entityType:j.CONTROL,url:r,loading:s,position:"middle",short:!0})},qa=s=>U(ne[s]),Da=(s,t)=>t.map(a=>({label:qa(a),link:s.base(a).url()})),ka=()=>{const s=[j.CLUSTER,j.NAMESPACE,j.NODE,j.DEPLOYMENT,j.IMAGE,j.SECRET],t=k(),a=D(),o=b.getURL(t,a),n=Da(o,s);return e.jsx(It,{text:"Application & Infrastructure",options:n})},Ma=s=>U(ne[s]),Fa=(s,t)=>t.map(a=>({label:Ma(a),link:s.base(a).url()})),_a=()=>{const s=[j.SUBJECT,j.SERVICE_ACCOUNT,j.ROLE],t=k(),a=D(),o=b.getURL(t,a),n=Fa(o,s);return e.jsx(It,{text:"Role-Based Access Control",options:n})},Ht=({isExporting:s,setIsExporting:t})=>{const{hasReadAccess:a}=gs(),o=a("WorkflowAdministration"),n=a("Compliance");return e.jsxs("div",{className:"flex flex-1 justify-end",children:[e.jsxs("div",{className:"border-base-400 border-r-2 mr-1 flex ",children:[o&&e.jsx(Oa,{}),n&&e.jsx(Ua,{}),e.jsx("div",{className:"flex w-32 mr-2",children:e.jsx(ka,{})}),e.jsx("div",{className:"flex w-32 mr-3 ",children:e.jsx(_a,{})})]}),e.jsx("div",{className:"flex items-center self-center",children:e.jsx(js,{fileName:"Config Management Dashboard Report",type:null,page:Ze.CONFIG_MANAGEMENT,pdfId:"capture-dashboard",isExporting:s,setIsExporting:t})})]})};Ht.propTypes={isExporting:C.bool.isRequired,setIsExporting:C.func.isRequired};const $s={READY:7},Ya=Na.map(s=>({title:Pn[s],color:xs[s]})),Gt="var(--base-400)",Oe={PASS:"Pass",FAIL:"Fail"},Va=q`
...
`,nr=s=>{let t="no";return s.forEach(a=>{if(a.metadata){const{startDate:o,endDate:n}=a.metadata;if(!o&&!n)return;const r=new Date().toISOString(),l=pt.isAfter(o,r),i=pt.isAfter(r,n);l?t="upcoming":i?t="expired":t="valid"}}),`has ${t} certs`},ar=()=>{const s=k(),t=D();function a(o){return!o||!o.secrets?[]:o.secrets.filter(n=>n.deploymentCount).sort((n,r)=>r.deploymentCount-n.deploymentCount).slice(0,10)}return e.jsx(H,{query:tr,children:({loading:o,data:n})=>{let r=e.jsx(B,{});const l=b.getURL(s,t).base(j.SECRET).url(),i=e.jsx(Re,{to:l,className:"no-underline btn-sm btn-base",children:"View all"});if(!o&&n){const u=a(n);r=e.jsx("ul",{className:"w-full columns-2 columns-gap-0",style:{columnRule:"1px solid var(--base-300)"},children:u.map((c,d)=>{const m=b.getURL(s,t).base(j.SECRET).push(c.id).url();return e.jsxs("li",{className:`inline-block flex flex-row border-base-300 w-full ${d!==4||d!==9?"border-b":""}`,children:[e.jsx("div",{className:"self-center text-2xl pl-4 pr-4",children:d+1}),e.jsxs("div",{className:"flex flex-col truncate pr-4 pb-4 pt-4",children:[e.jsxs("span",{className:"text-sm",children:[c.clusterName,"/",c.namespace]}),e.jsx(Re,{to:m,children:c.name}),c.deploymentCount>0&&e.jsxs("span",{className:"truncate text-sm",children:[`${c.deploymentCount} ${U("deployment",c.deploymentCount)}, `,nr(c.files)]})]})]},c.id)})})}return e.jsx(Y,{className:"s-2 overflow-hidden pdf-page",header:"Secrets most used across deployments",headerComponents:i,children:r})}})},rr=()=>{const[s,t]=I.useState(!1),{hasReadAccess:a}=gs(),o=a("Alert")&&a("WorkflowAdministration"),n=a("Compliance"),r=a("Cluster")&&a("K8sRoleBinding")&&a("K8sSubject"),l=a("Deployment")&&a("Secret");return e.jsxs(e.Fragment,{children:[e.jsxs(Vn,{headerText:En[Ze.CONFIG_MANAGEMENT],headerComponents:e.jsx(Ht,{isExporting:s,setIsExporting:t}),children:[o&&e.jsx(Ga,{}),n&&e.jsx(Is,{className:"pdf-page",standardOptions:[In.CIS_Kubernetes_v1_5]}),r&&e.jsx(sr,{}),l&&e.jsx(ar,{})]}),s&&e.jsx(Ss,{})]})},_e=I.createContext(),Jt={sortParam:Et.page,pageParam:St.page},Zt={sortParam:Et.sidePanel,pageParam:St.sidePanel},Xt=(s,t,a)=>{const o=I.useCallback(n=>{const{target:r}=n;s.current&&r instanceof HTMLElement&&!s.current.contains(r)&&t()},[t,s]);I.useEffect(()=>(a&&document.addEventListener("mousedown",o),()=>{a&&document.removeEventListener("mousedown",o)}),[a,o])};function ye(s,t){return`${wn}/${On[s]}/${t}`}const or=!0,Ne=({headerText:s,query:t,variables:a,entityType:o,tableColumns:n,createTableRows:r,selectedRowId:l,idAttribute:i,defaultSorted:u,defaultSearchOptions:c,data:d,totalResults:m,autoFocusSearchInput:p,noDataText:h})=>{const f=k(),g=D(),y=be(),N=I.useContext(De),S=I.useContext(_e),P=N.paging[S.pageParam],A=N.sort[S.sortParam]||u,[T,E]=I.useState({});function v(K){const W=Xe(K,i),Z=b.getURL(f,g).push(W).url();y(Z)}const L=[At[o]],Q=`Filter ${U(ne[o])}`;function Se(K,W,Z){const Ee=`${Z} ${U(s||ne[o],Z)}`;return e.jsxs(Ts,{testid:"panel",children:[e.jsxs(Rs,{children:[e.jsx(Ft,{testid:"panel-header",text:Ee}),e.jsx(vs,{children:K})]}),e.jsx(Ps,{children:e.jsx(es,{rows:W,columns:n,onRowClick:v,idAttribute:i,id:"capture-list",selectedRowId:l,noDataText:h,page:P,sorted:A,onSortedChange:le,manual:or,disableSortRemove:!0})})]})}function ve(K){y(N.setPage(K).toUrl())}function le(K,W){const Z=K.map(Ye=>{const mt=T[Ye.id]||W.sortField;E({[Ye.id]:mt,...T});const{desc:gn}=Ye;return{id:mt,desc:gn}}),Ee=N.setSort(Z).toUrl();y(Ee)}function Me(K){return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"flex flex-1 justify-start",children:e.jsx(H,{query:_t,action:"list",variables:{categories:L},children:({data:W})=>{const Z=W&&W.searchOptions?[...W.searchOptions,...c]:[];return e.jsx(kt,{placeholder:Q,className:"w-full",categoryOptions:Z,categories:L,autoFocus:p})}})}),e.jsx(Es,{page:P,dataLength:K,setPage:ve,pageSize:ms})]})}if(d){const K=Me(m);return d.length&&Ke(d,o,t,"capture-list",n),Se(K,d,m)}const Fe={...a,pagination:w.getPagination(A,P,ms)};return e.jsx("section",{className:"h-full w-full",id:"capture-list",children:e.jsx(H,{query:t,variables:Fe,children:({loading:K,data:W})=>{if(ae(K,d))return e.jsx(B,{});if(!W)return e.jsx(te,{resourceType:o,useCase:Ze.CONFIG_MANAGEMENT});const Z=r(W)??[],Ee=(W==null?void 0:W.count)||0,Ye=Me(Ee);return Z.length&&Ke(Z,o,t,"capture-list",n),Se(Ye,Z,Ee)}})})};Ne.propTypes={query:C.shape().isRequired,variables:C.shape(),entityType:C.string.isRequired,tableColumns:C.arrayOf(C.shape({})).isRequired,createTableRows:C.func.isRequired,selectedRowId:C.string,idAttribute:C.string.isRequired,headerText:C.string,defaultSorted:C.arrayOf(C.shape({})),defaultSearchOptions:C.arrayOf(C.string),data:C.arrayOf(C.shape({})),totalResults:C.number,autoFocusSearchInput:C.bool,noDataText:C.string};Ne.defaultProps={variables:{},headerText:"",selectedRowId:null,defaultSorted:[],defaultSearchOptions:[],data:null,totalResults:null,autoFocusSearchInput:!0,noDataText:"No results found. Please refine your search."};function qe({text:s,isTextOnly:t}){const a=e.jsx(Ln,{children:e.jsx(Un,{color:"var(--pf-t--global--icon--color--status--warning--default)"})});return e.jsx(Tt,{icon:a,text:s,isTextOnly:t})}const Ae=(s,t)=>{if(!t||!s)return s;const a=yt(t);return s.filter(o=>{let n=!1;if(o.policyStatus&&o.policyStatus.failingPolicies){const{length:r}=o.policyStatus.failingPolicies;r||(n=!0)}else o.policyStatus==="pass"&&(n=!0);return a===z.POLICY_STATUS.VALUES.PASS?n:a===z.POLICY_STATUS.VALUES.FAIL?!n:!0})},lr=q`
...
`,kr=s=>{const t=Object.keys(s).reduce((a,o)=>{const n=s[o];return a[`${o} Id`]=n,a},{});return w.objectToWhereClause(t)},Mr=s=>{const t=s.reduce((a,o)=>[...a,...o.complianceControl.complianceControlFailingNodes],[]);return bt(t,"id").map(a=>({...a,passing:!1}))},Fr=s=>{const t=s.reduce((a,o)=>[...a,...o.complianceControl.complianceControlPassingNodes],[]);return bt(t,"id").map(a=>({...a,passing:!0}))},Ys=s=>{const{entityType:t,entityContext:a}=s,{loading:o,error:n,data:r}=qt(Dr,{variables:{query:kr(a)},fetchPolicy:"no-cache"});if(o)return e.jsx("div",{className:"flex flex-1 items-center justify-center p-6",children:e.jsx(B,{})});if(n&&Dn.captureException(n),!r)return null;const{executedControls:l=[]}=r;if(l.length===0)return e.jsx(X,{message:`No nodes failing ${t===j.CONTROL?"this control":"any controls"}`,className:"p-6",icon:"info"});const i=Mr(l),u=Fr(l),c=i.length,d=u.length;if(d&&!c)return e.jsx(X,{message:`No nodes failing ${t===j.CONTROL?"this control":"any controls"}`,className:"p-3 shadow",icon:"info"});if(!d&&!c)return e.jsx(X,{message:`Findings ${a[j.CONTROL]?"for this control":"across controls"} could not be assessed`,className:"p-3 shadow",icon:"warn"});const m=`${c} ${c===1?"node is":"nodes are"} ${t===j.CONTROL?"failing this control":"failing controls"}`;return e.jsx(Ie,{entityType:j.NODE,header:m,rows:i,noDataText:"No Nodes",className:"bg-base-100 w-full",columns:Gn[j.NODE],idAttribute:"id",defaultSorted:[{id:"name",desc:!1}]})};Ys.propTypes={entityType:C.string.isRequired,entityContext:C.shape({}).isRequired};const _r=q`
