import{m4 as A,mJ as Ae,mK as H,mL as Z,cb as X,lS as Y,dr as J,t as e,ax as ee,ay as te,X as D,az as y,l$ as Be,dd as se,aA as re,ao as d,b0 as ae,mM as ne,b1 as R,mN as je,lT as ie,mO as le,mm as B,ez as Ne,lY as Me,lZ as ft,l_ as gt,m0 as bt,mj as fe,mP as we,lJ as ke,b3 as vt,cq as Ue,ae as _,m2 as ze,bF as ge,d0 as Ke,mQ as Et,cu as be,ct as ve,lw as Ee,cv as Se,m8 as Te,ds as Ve,m9 as St,ma as Tt,ag as oe,a3 as T,at as q,a4 as w,au as Ce,mb as Vt,aO as Ft,bK as Lt,I as Pt,mR as It,md as $t,ly as Fe,me as Qe,mS as Ge,ll as Le,mT as Pe,mo as Dt,dH as qt,aI as ce,aK as ue,aL as de,bC as pe,bg as M,ba as We,b6 as He,b7 as Ze,ms as Xe,b8 as Ye,d_ as Ie,dZ as Je,aR as he,d7 as $e,bL as Ot,my as et,b9 as k,mu as tt,mv as G,dS as st,fP as W,mx as rt,cs as at,bc as ye,bP as nt,ck as it,cd as lt,bd as _t,cg as Rt,ch as U,ci as z,cj as K,mU as ot,dY as At,fy as Bt,dX as Nt,mA as Mt,mC as me,a5 as wt,a6 as qe,aY as kt,mD as Ut,c8 as zt,c9 as Q,eW as Kt}from"./index-DDX4dntO.js";import{u as $,g as j,f as Qt,r as Gt}from"./apollo-BxVF6eGb.js";import{u as Wt,a as Ht,b as Zt,S as Xt,c as Yt,E as Jt}from"./ExpandableLabelSection-BkoPIZS3.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-SrEPSx5Q.js";const es=j`
...
`,ts=[A,Ae,H,Z],Oe={field:A,direction:"asc"};function ss({querySearchFilter:s,isFiltered:t,pagination:a,sortOption:n,getSortParams:r,onClearFilters:i}){const{page:l,perPage:o}=a,{data:c,previousData:x,error:u,loading:g}=$(es,{variables:{query:Y(s),pagination:X({page:l,perPage:o,sortOption:n})}}),f=c??x,V=J({isLoading:g,data:f==null?void 0:f.clusters,error:u,searchFilter:s});return e.jsxs(ee,{borders:V.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":g?"true":"false",children:[e.jsx(te,{noWrap:!0,children:e.jsxs(D,{children:[e.jsx(y,{sort:r(A),children:"Cluster"}),e.jsxs(y,{sort:r(Ae),children:["CVEs",t&&e.jsx(Be,{})]}),e.jsx(y,{sort:r(H),children:"Platform type"}),e.jsx(y,{sort:r(Z),children:"Kubernetes version"})]})}),e.jsx(se,{tableState:V,colSpan:4,emptyProps:{message:"No secured clusters have been detected"},filteredEmptyProps:{onClearFilters:i},renderer:({data:F})=>F.map(({id:P,name:b,clusterVulnerabilityCount:L,type:C,status:h})=>{var v;return e.jsx(re,{children:e.jsxs(D,{children:[e.jsx(d,{dataLabel:"Cluster",modifier:"nowrap",children:e.jsx(ae,{to:ne("Cluster",P),children:b})}),e.jsx(d,{dataLabel:"CVEs",children:R(L,"CVE")}),e.jsx(d,{dataLabel:"Platform type",children:je(C)}),e.jsx(d,{dataLabel:"Kubernetes version",children:((v=h==null?void 0:h.orchestratorMetadata)==null?void 0:v.version)??"Unavailable"})]})},P)})})]})}const rs=j`
...
`;function ps({tableState:s,getSortParams:t,onClearFilters:a}){return e.jsxs(ee,{borders:s.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":s.type==="LOADING"?"true":"false",children:[e.jsx(te,{noWrap:!0,children:e.jsxs(D,{children:[e.jsx(y,{sort:t(A),children:"Cluster"}),e.jsx(y,{sort:t(H),children:"Cluster type"}),e.jsx(y,{children:"CVE status"}),e.jsx(y,{sort:t(Z),children:"Kubernetes version"})]})}),e.jsx(se,{tableState:s,colSpan:3,emptyProps:{message:"No clusters have been reported for this CVE"},filteredEmptyProps:{onClearFilters:a},renderer:({data:n})=>e.jsx(re,{children:n.map(({id:r,name:i,type:l,clusterVulnerabilities:o,status:c})=>{var u;const x=Dt(o);return e.jsxs(D,{children:[e.jsx(d,{dataLabel:"Cluster",children:e.jsx(ae,{to:ne("Cluster",r),children:e.jsx(qt,{position:"middle",content:i})})}),e.jsx(d,{dataLabel:"Cluster type",modifier:"nowrap",children:je(l)}),e.jsx(d,{dataLabel:"CVE status",children:e.jsx(fe,{isFixable:x})}),e.jsx(d,{dataLabel:"Kubernetes version",modifier:"nowrap",children:((u=c==null?void 0:c.orchestratorMetadata)==null?void 0:u.version)??"Unavailable"})]},r)})})})]})}const hs=j`
    ${Cs}
...
`;function ys({query:s,...t}){var n,r,i;const a=$(hs,{variables:{query:s,pagination:X(t)}});return{affectedClustersRequest:a,clusterCount:((n=a.data)==null?void 0:n.clusterCount)??0,clusterData:((r=a.data)==null?void 0:r.clusters)??((i=a.previousData)==null?void 0:i.clusters)}}const ct=j`
...
`;function gs(s){return $(fs,{variables:{cveID:s}})}function bs({affectedClusterCount:s,totalClusterCount:t}){return e.jsxs(ce,{isCompact:!0,isFullHeight:!0,children:[e.jsx(ue,{children:"Affected clusters"}),e.jsx(de,{children:e.jsx(pe,{children:e.jsxs(M,{span:12,className:"pf-v6-u-pt-sm",children:[s," / ",t," affected clusters"]})})})]})}const vs=j`
    ${ct}
...
`;function Gs(s,t){return $(Qs,{variables:{id:s,query:t}})}const Ws=[Ge];function Hs({clusterId:s}){var v,O;const{analyticsTrack:t}=ge(),a=Le(t),{searchFilter:n,setSearchFilter:r}=be(),i=Te(n),l=Nt(i),o=Ve(i),{page:c,perPage:x,setPage:u,setPerPage:g}=ve(Ee),{sortOption:f,getSortParams:V}=Se({sortFields:Ds,defaultSortOption:qs,onSort:()=>u(1)}),{data:m,loading:F,error:P}=As({clusterId:s,query:l,page:c,perPage:x,sortOption:f}),b=Gs(s,l),L=Mt(i),C=((v=m==null?void 0:m.cluster)==null?void 0:v.clusterVulnerabilityCount)??0,h=J({isLoading:F,error:P,data:(O=m==null?void 0:m.cluster)==null?void 0:O.clusterVulnerabilities,searchFilter:i});return e.jsxs(e.Fragment,{children:[e.jsx(T,{component:"div",children:e.jsx(_,{component:"p",children:"Review and triage vulnerability data scanned on this cluster"})}),e.jsx(k,{component:"div"}),e.jsxs(T,{hasBodyWrapper:!1,isFilled:!0,children:[e.jsx(Fe,{className:"pf-v6-u-pb-0 pf-v6-u-px-sm",searchFilter:n,searchFilterConfig:Ws,cveStatusFilterField:"CLUSTER CVE FIXABLE",onFilterChange:(E,p)=>{r(E),a(Pe,p)},includeCveSeverityFilters:!1}),e.jsxs(tt,{isLoading:b.loading,error:b.error,children:[e.jsx(G,{loadingText:"Loading platform CVEs by status summary",data:b.data,renderer:({data:E})=>e.jsx(ks,{data:E.cluster.platformCVECountByFixability,hiddenStatuses:L})}),e.jsx(G,{loadingText:"Loading platform CVEs by type summary",data:b.data,renderer:({data:E})=>e.jsx(Ks,{data:E.cluster.platformCVECountByType})})]}),e.jsx(k,{component:"div"}),e.jsxs(st,{hasGutter:!0,className:"pf-v6-u-align-items-baseline",children:[e.jsx(W,{isFilled:!0,children:e.jsxs(q,{alignItems:{default:"alignItemsCenter"},children:[e.jsx(w,{headingLevel:"h2",className:"pf-v6-u-w-50",children:m?`${R(C,"result")} found`:e.jsx(Ie,{screenreaderText:"Loading cluster vulnerability count"})}),o&&e.jsx(rt,{})]})}),e.jsx(W,{children:e.jsx(at,{itemCount:C,perPage:x,page:c,onSetPage:(E,p)=>u(p),onPerPageSelect:(E,p)=>{g(p)}})})]}),e.jsx(_s,{tableState:h,getSortParams:V,onClearFilters:()=>{r({}),u(1)}})]})]})}const Zs="ClusterPageDetails",Xs="ClusterPageVulnerabilities",Ys=Xe("Platform",{entityTab:"Cluster"}),Js=j`
    ${Fs}
