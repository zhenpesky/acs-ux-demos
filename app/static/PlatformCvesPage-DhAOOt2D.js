import{mo as B,n1 as Me,n2 as Y,n3 as J,ck as ee,ma as te,dG as se,w as e,aG as re,aH as ae,a5 as D,aI as f,mj as ke,dt as ne,aJ as ie,ax as d,b9 as le,n4 as oe,ba as _,n5 as Ee,mb as ce,n6 as ue,mG as N,eP as Ue,mg as ze,mh as jt,mi as gt,mk as bt,mD as Se,n7 as Ke,m1 as Ge,bc as vt,cx as Qe,an as R,mm as We,bO as Te,d7 as He,n8 as Et,cB as Ve,cA as Fe,lQ as Pe,cC as Le,jV as St,ms as Ie,dH as De,mt as Tt,kF as Vt,kG as Ft,kH as Pt,lS as $e,mu as Xe,n9 as Ze,lJ as qe,na as Oe,mz as Lt,ap as de,ac as b,aC as $,ad as z,aD as je,mA as It,aX as Dt,bT as $t,K as qt,nb as Ot,mC as At,mI as Rt,dX as _t,aR as pe,aT as xe,aU as me,bL as ge,bp as U,bj as Ye,bf as Je,bg as et,mM as tt,bh as st,ee as Ae,ed as rt,a_ as be,dj as Re,bU as Bt,mS as at,bi as K,mO as nt,mP as X,e6 as it,g0 as Z,mR as lt,cz as ot,bl as ve,bY as ct,cr as ut,dU as dt,bm as Nt,cn as wt,co as G,cp as Q,cq as W,nc as pt,ec as Mt,fL as kt,eb as Ut,mU as zt,mW as fe,ae as Kt,af as _e,b5 as Gt,mX as Qt,ch as Wt,ci as H,fa as Ht}from"./index-C1geVYTJ.js";import{u as I,g as j,f as Xt,r as Zt}from"./apollo-BxVF6eGb.js";import{u as Yt,a as Jt,b as es,S as ts,c as ss,E as rs}from"./ExpandableLabelSection-B6n4Hra2.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-tCt1W6Qi.js";const as=j`
...
`;function Os(s){return I(qs,{variables:{id:s}})}function we(s){if(!s)return null;const{region:t}=s;return s.aws?`AWS ${t}`:s.azure?`Azure ${t}`:s.google?`GCP ${t}`:null}function As({clusterId:s}){var r,i,l,o,c,p;const{data:t,loading:a,error:n}=Os(s);return e.jsxs(e.Fragment,{children:[e.jsx(b,{component:"div",children:e.jsx(R,{component:"p",children:"View details about this cluster"})}),e.jsx(K,{component:"div"}),e.jsx(b,{isFilled:!0,children:n?e.jsx(ve,{children:e.jsx(ct,{title:"There was an error loading the cluster details",headingLevel:"h2",icon:dt,status:"danger",children:ut(n)})}):a?e.jsx(ve,{children:e.jsx(Nt,{size:"xl"})}):t&&e.jsxs($,{direction:{default:"column"},spaceItems:{default:"spaceItemsXl"},children:[e.jsxs(wt,{columnModifier:{default:"1Col"},children:[e.jsxs(G,{children:[e.jsx(Q,{children:"Cluster type"}),e.jsx(W,{children:Ee(t.cluster.type)})]}),we((r=t.cluster.status)==null?void 0:r.providerMetadata)&&e.jsxs(G,{children:[e.jsx(Q,{children:"Cloud provider"}),e.jsx(W,{children:we((i=t.cluster.status)==null?void 0:i.providerMetadata)})]}),((o=(l=t.cluster.status)==null?void 0:l.orchestratorMetadata)==null?void 0:o.buildDate)&&e.jsxs(G,{children:[e.jsx(Q,{children:"Build date"}),e.jsx(W,{children:Re(t.cluster.status.orchestratorMetadata.buildDate)})]}),((p=(c=t.cluster.status)==null?void 0:c.orchestratorMetadata)==null?void 0:p.version)&&e.jsxs(G,{children:[e.jsx(Q,{children:"K8s version"}),e.jsx(W,{children:t.cluster.status.orchestratorMetadata.version})]})]}),e.jsx(rs,{toggleText:"Labels",labels:t.cluster.labels})]})})]})}const Rs=[ce,pt,ue,N],_s={field:N,direction:"desc"},Bs=j`
...
`;function Ns({tableState:s,getSortParams:t,onClearFilters:a}){const r=Ue();return e.jsxs(re,{borders:s.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":s.type==="LOADING"?"true":"false",children:[e.jsx(ae,{noWrap:!0,children:e.jsxs(D,{children:[e.jsx(ze,{}),e.jsx(f,{sort:t(ce),children:"CVE"}),e.jsx(f,{sort:t(pt),children:"CVE status"}),e.jsx(f,{sort:t(ue),children:"CVE type"}),e.jsx(f,{sort:t(N),children:"CVSS"})]})}),e.jsx(ne,{tableState:s,colSpan:5,emptyProps:{message:"No CVEs were detected for this cluster"},filteredEmptyProps:{onClearFilters:a},renderer:({data:i})=>i.map((l,o)=>{const{id:c,cve:p,isFixable:u,vulnerabilityType:v,cvss:g,scoreVersion:T,summary:x}=l,V=r.has(p);return e.jsxs(ie,{isExpanded:V,children:[e.jsxs(D,{children:[e.jsx(d,{expand:{rowIndex:o,isExpanded:V,onToggle:()=>r.toggle(p)}}),e.jsx(d,{dataLabel:"CVE",modifier:"nowrap",children:e.jsx(le,{to:oe("CVE",c),children:p})}),e.jsx(d,{dataLabel:"CVE status",children:e.jsx(Se,{isFixable:u})}),e.jsx(d,{dataLabel:"CVE type",children:Ke(v)}),e.jsx(d,{dataLabel:"CVSS",children:e.jsx(Ge,{cvss:g,scoreVersion:T})})]}),e.jsxs(D,{isExpanded:V,children:[e.jsx(d,{}),e.jsx(d,{colSpan:4,children:e.jsx(Qe,{children:x?e.jsx(R,{component:"p",children:x}):e.jsx(We,{})})})]})]},p)})})]})}const ws=j`
    ${Bs}
...
`;function ar(){var c;const{clusterId:s}=Ye(),{data:t,error:a}=I(rr,{variables:{id:s}}),[n,r]=He("detailsTab",fe),i=fe[0],l=fe[1],o=((c=t==null?void 0:t.cluster)==null?void 0:c.name)??"";return e.jsxs(e.Fragment,{children:[e.jsx(de,{title:`Platform CVEs - Cluster ${o}`}),e.jsx(b,{type:"breadcrumb",children:e.jsxs(Je,{children:[e.jsx(et,{to:sr,children:"Clusters"}),e.jsx(st,{isActive:!0,children:o??e.jsx(Ae,{screenreaderText:"Loading cluster name",width:"200px"})})]})}),a?e.jsx(b,{hasBodyWrapper:!1,children:e.jsx(ve,{children:e.jsx(ct,{title:ut(a),headingLevel:"h2",icon:dt,status:"danger"})})}):e.jsxs(e.Fragment,{children:[e.jsx(b,{hasBodyWrapper:!1,children:e.jsx($s,{data:t==null?void 0:t.cluster})}),e.jsx(b,{type:"tabs",children:e.jsxs(Kt,{activeKey:n,onSelect:(p,u)=>{r(u)},usePageInsets:!0,mountOnEnter:!0,unmountOnExit:!0,children:[e.jsx(_e,{eventKey:i,tabContentId:tr,title:i,children:e.jsx(Js,{clusterId:s})}),e.jsx(_e,{eventKey:l,tabContentId:er,title:l,children:e.jsx(As,{clusterId:s})})]})})]})]})}function pr(){const{hasReadAccess:s}=Gt(),t=s("Integration");return e.jsxs(e.Fragment,{children:[t&&e.jsx(Qt,{}),e.jsxs(Wt,{children:[e.jsx(H,{index:!0,element:e.jsx(Cs,{})}),e.jsx(H,{path:"cves/:cveId",element:e.jsx(Is,{})}),e.jsx(H,{path:"clusters/:clusterId",element:e.jsx(ar,{})}),e.jsx(H,{path:"*",element:e.jsxs(b,{hasBodyWrapper:!1,children:[e.jsx(de,{title:"Platform CVEs - Not Found"}),e.jsx(Ht,{})]})})]})]})}export{pr as default};
