import{mn as B,n0 as Me,n1 as Y,n2 as J,ck as ee,m9 as te,dz as se,w as e,aG as re,aH as ae,a5 as $,aI as f,mi as ke,dl as ne,aJ as ie,ax as d,b9 as le,n3 as oe,ba as _,n4 as Ee,ma as ce,n5 as ue,mF as N,eI as Ue,mf as ze,mg as jt,mh as gt,mj as bt,mC as Se,n6 as Ke,m0 as Qe,bc as vt,cx as We,an as R,ml as Ge,bO as Te,d7 as He,n7 as Et,cB as Ve,cA as Fe,lP as Le,cC as Pe,jT as St,mr as Ie,dA as $e,ms as Tt,kD as Vt,kE as Ft,kF as Lt,lR as De,mt as Ze,n8 as Xe,lI as qe,n9 as Oe,my as Pt,ap as de,ac as b,aC as D,ad as z,aD as je,mz as It,aX as $t,bT as Dt,K as qt,na as Ot,mB as At,mH as Rt,dQ as _t,aR as pe,aT as xe,aU as me,bL as ge,bp as U,bj as Ye,bf as Je,bg as et,mL as tt,bh as st,e7 as Ae,e6 as rt,a_ as be,df as Re,bU as Bt,mR as at,bi as K,mN as nt,mO as Z,d$ as it,fY as X,mQ as lt,cz as ot,bl as ve,bY as ct,cr as ut,dN as dt,bm as Nt,cn as wt,co as Q,cp as W,cq as G,nb as pt,e5 as Mt,fH as kt,e4 as Ut,mT as zt,mV as fe,ae as Kt,af as _e,b5 as Qt,mW as Wt,ch as Gt,ci as H,f3 as Ht}from"./index-DPKKNpht.js";import{u as I,g as j,f as Zt,r as Xt}from"./apollo-BxVF6eGb.js";import{u as Yt,a as Jt,b as es,S as ts,c as ss,E as rs}from"./ExpandableLabelSection-B86_0kAI.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-q8ehAm7E.js";const as=j`
...
`;function Ns({tableState:s,getSortParams:t,onClearFilters:a}){const r=Ue();return e.jsxs(re,{borders:s.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":s.type==="LOADING"?"true":"false",children:[e.jsx(ae,{noWrap:!0,children:e.jsxs($,{children:[e.jsx(ze,{}),e.jsx(f,{sort:t(ce),children:"CVE"}),e.jsx(f,{sort:t(pt),children:"CVE status"}),e.jsx(f,{sort:t(ue),children:"CVE type"}),e.jsx(f,{sort:t(N),children:"CVSS"})]})}),e.jsx(ne,{tableState:s,colSpan:5,emptyProps:{message:"No CVEs were detected for this cluster"},filteredEmptyProps:{onClearFilters:a},renderer:({data:i})=>i.map((l,o)=>{const{id:c,cve:p,isFixable:u,vulnerabilityType:v,cvss:g,scoreVersion:T,summary:x}=l,V=r.has(p);return e.jsxs(ie,{isExpanded:V,children:[e.jsxs($,{children:[e.jsx(d,{expand:{rowIndex:o,isExpanded:V,onToggle:()=>r.toggle(p)}}),e.jsx(d,{dataLabel:"CVE",modifier:"nowrap",children:e.jsx(le,{to:oe("CVE",c),children:p})}),e.jsx(d,{dataLabel:"CVE status",children:e.jsx(Se,{isFixable:u})}),e.jsx(d,{dataLabel:"CVE type",children:Ke(v)}),e.jsx(d,{dataLabel:"CVSS",children:e.jsx(Qe,{cvss:g,scoreVersion:T})})]}),e.jsxs($,{isExpanded:V,children:[e.jsx(d,{}),e.jsx(d,{colSpan:4,children:e.jsx(We,{children:x?e.jsx(R,{component:"p",children:x}):e.jsx(Ge,{})})})]})]},p)})})]})}const ws=j`
    ${Bs}
