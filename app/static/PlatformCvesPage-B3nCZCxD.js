import{md as B,mS as Me,mT as Y,mU as J,cc as ee,l$ as te,ds as se,w as e,az as re,aA as ae,Z as $,aB as f,m8 as ke,de as ne,aC as ie,aq as d,b1 as le,mV as oe,b2 as R,mW as Ee,m0 as ce,mX as ue,mv as w,eA as Ue,m5 as Ke,m6 as jt,m7 as gt,m9 as bt,ms as Se,mY as ze,lS as Qe,b4 as vt,cr as Ge,ag as _,mb as We,bG as Te,d1 as He,mZ as Et,cv as Ve,cu as Fe,lF as Le,cw as Pe,jN as St,mh as Ie,dt as $e,mi as Tt,kv as Vt,kw as Ft,kx as Lt,lH as De,mj as Ze,m_ as Xe,ly as qe,m$ as Oe,mo as Pt,ai as de,a5 as b,av as D,a6 as K,aw as je,mp as It,aP as $t,bL as Dt,K as qt,n0 as Ot,mr as At,mx as _t,dI as Rt,aK as pe,aL as me,aM as xe,bD as ge,bh as U,bb as Ye,b7 as Je,b8 as et,mB as tt,b9 as st,d$ as Ae,d_ as rt,aS as be,d8 as _e,bM as Bt,mH as at,ba as z,mD as nt,mE as Z,dT as it,fQ as X,mG as lt,ct as ot,bd as ve,bQ as ct,cl as ut,ce as dt,be as wt,ch as Nt,ci as Q,cj as G,ck as W,n1 as pt,dZ as Mt,fz as kt,dY as Ut,mJ as Kt,mL as fe,a7 as zt,a8 as Re,aZ as Qt,mM as Gt,c9 as Wt,ca as H,eX as Ht}from"./index-C42KAxkv.js";import{u as I,g as j,f as Zt,r as Xt}from"./apollo-BxVF6eGb.js";import{u as Yt,a as Jt,b as es,S as ts,c as ss,E as rs}from"./ExpandableLabelSection-CF_VkOW4.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-BCJtpQCN.js";const as=j`
...
`,us=[ce,ue,w],we={field:w,direction:"desc"};function ds({querySearchFilter:s,isFiltered:t,pagination:a,selectedCves:n,canSelectRows:r,createRowActions:i,sortOption:l,getSortParams:o,onClearFilters:c}){var S;const{page:p,perPage:u}=a,{data:v,previousData:g,error:T,loading:m}=os({querySearchFilter:s,page:p,perPage:u,sortOption:l}),P=((S=I(cs).data)==null?void 0:S.clusterCount)??0,E=v??g,F=se({isLoading:m,data:E==null?void 0:E.platformCVEs,error:T,searchFilter:s}),x=Ue(),y=r?8:6;return e.jsxs(re,{borders:F.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":m?"true":"false",children:[e.jsx(ae,{noWrap:!0,children:e.jsxs($,{children:[e.jsx(Ke,{}),r&&e.jsx(jt,{selectedCves:n}),e.jsx(f,{sort:o(ce),children:"CVE"}),e.jsx(f,{children:"CVE status"}),e.jsx(f,{sort:o(ue),children:"CVE type"}),e.jsx(f,{sort:o(w),children:"CVSS"}),e.jsxs(gt,{tooltip:"Ratio of the number of clusters affected by this CVE to the total number of secured clusters",sort:void 0,children:["Affected clusters",t&&e.jsx(ke,{})]}),r&&e.jsx(f,{screenReaderText:"Row actions"})]})}),e.jsx(ne,{tableState:F,colSpan:y,emptyProps:{message:"No CVEs have been detected for your secured clusters"},filteredEmptyProps:{onClearFilters:c},renderer:({data:q})=>q.map((h,C)=>{const{id:L,cve:O,isFixable:N,cveType:Ce,cvss:he,clusterVulnerability:{summary:M,scoreVersion:A},clusterCountByType:k}=h,ye=x.has(O),{generic:xt,kubernetes:Ct,openshift:ht,openshift4:yt}=k,ft=xt+Ct+ht+yt;return e.jsxs(ie,{isExpanded:ye,children:[e.jsxs($,{children:[e.jsx(d,{expand:{rowIndex:C,isExpanded:ye,onToggle:()=>x.toggle(O)}}),r&&e.jsx(bt,{selectedCves:n,rowIndex:C,item:{cve:O}}),e.jsx(d,{dataLabel:"CVE",modifier:"nowrap",children:e.jsx(le,{to:oe("CVE",L),children:O})}),e.jsx(d,{dataLabel:"CVE status",children:e.jsx(Se,{isFixable:N})}),e.jsx(d,{dataLabel:"CVE type",children:ze(Ce)}),e.jsx(d,{dataLabel:"CVSS",children:e.jsx(Qe,{cvss:he,scoreVersion:A})}),e.jsxs(d,{dataLabel:"Affected clusters",children:[ft," / ",P," affected clusters"]}),r&&e.jsx(d,{isActionCell:!0,children:e.jsx(vt,{items:i({cve:O})})})]}),e.jsxs($,{isExpanded:ye,children:[e.jsx(d,{}),e.jsx(d,{colSpan:y-1,children:e.jsx(Ge,{children:M?e.jsx(_,{component:"p",children:M}):e.jsx(We,{})})})]})]},L)})})]})}const ps=j`
    query getPlatformCVEEntityCounts($query: String) {
        platformCVECount(query: $query)
        clusterCount(query: $query)
    }
`;function ms(s){return I(ps,{variables:{query:te(s)}})}const xs=[Ze,Xe];function Cs(){var M;const s=Zt(),{analyticsTrack:t}=Te(),a=qe(t),[n]=He("entityTab",Et),{searchFilter:r,setSearchFilter:i}=Ve(),l=Fe(Le),{sortOption:o,getSortParams:c,setSortOption:p}=Pe({sortFields:n==="CVE"?us:ns,defaultSortOption:n==="CVE"?we:Be,onSort:()=>l.setPage(1)});St({destination:"platform-cves",searchFilter:r,setSearchFilter:i,reapplyWhen:[n],onScopeApplied:()=>l.setPage(1)});const u=Ie(r),v=$e(u),g=((M=u["CVE Snoozed"])==null?void 0:M[0])==="true",T=Yt(),m=Tt(),{snoozeModalOptions:V,setSnoozeModalOptions:P,snoozeActionCreator:E}=Jt(),F=es("Platform");function x(A){l.setPage(1),p(A==="CVE"?we:Be),t({event:Ot,properties:{type:A,page:"Overview"}})}Xt.useEffect(()=>{x(n)},[]);const{data:y}=ms(u),S={CVE:(y==null?void 0:y.platformCVECount)??0,Cluster:(y==null?void 0:y.clusterCount)??0};function q(){i({}),l.setPage(1)}const h=Vt(),C=h==="v1"||h==="v2",L=Ft({enabled:C&&h==="v1",searchFilter:r,setSearchFilter:i,paginationSetPage:()=>l.setPage(1),storageScope:"platform-cves",filterKind:"workload"}),O=Lt({enabled:C&&h==="v2",searchFilter:r,setSearchFilter:i,paginationSetPage:()=>l.setPage(1),storageScope:"platform-cves",filterKind:"workload"}),N=h==="v2"?O:L,Ce=e.jsx(De,{searchFilter:r,searchFilterConfig:xs,defaultSearchFilterEntity:"CVE",cveStatusFilterField:"CLUSTER CVE FIXABLE",onFilterChange:(A,k)=>{i(A),a(Oe,k)},includeCveSeverityFilters:!1,prefixToolbarItems:N.prefixToolbarItem??void 0,appliedFilterSuffix:N.appliedFilterSuffix??void 0}),he=e.jsx(At,{entityTabs:["CVE","Cluster"],entityCounts:S,onChange:x});return e.jsxs(e.Fragment,{children:[V&&e.jsx(ts,{...V,onSuccess:(A,k)=>{A==="SNOOZE"&&t({event:Pt,properties:{type:"PLATFORM",duration:k}}),s.cache.evict({fieldName:"platformCVEs"}),s.cache.evict({fieldName:"platformCVECount"}),s.cache.gc(),m.clear()},onClose:()=>P(null)}),e.jsx(de,{title:"Kubernetes Components Overview"}),e.jsx(b,{children:e.jsxs(D,{alignItems:{default:"alignItemsCenter"},grow:{default:"grow"},children:[e.jsxs(D,{direction:{default:"column"},grow:{default:"grow"},children:[e.jsx(K,{headingLevel:"h1",children:"Kubernetes components"}),e.jsx(je,{children:"Prioritize and manage scanned CVEs across clusters"})]}),e.jsx(je,{children:e.jsx(ss,{searchFilter:r,setSearchFilter:i,snoozedCveCount:F})})]})}),h==="v2"&&O.wysiwygAlert&&e.jsx(b,{children:O.wysiwygAlert}),e.jsxs(b,{isFilled:!0,children:[e.jsx(It,{filterToolbar:Ce,entityToggleGroup:he,pagination:l,tableRowCount:n==="CVE"?S.CVE:S.Cluster,isFiltered:v,children:T&&e.jsx($t,{align:{default:"alignEnd"},children:e.jsx(Dt,{toggleText:"Bulk actions",isDisabled:m.size===0,children:e.jsx(qt,{onClick:()=>P({action:g?"UNSNOOZE":"SNOOZE",cveType:"CLUSTER_CVE",cves:Array.from(m.values())}),children:g?"Unsnooze CVEs":"Snooze CVEs"},"bulk-snooze-cve")})})}),n==="CVE"&&e.jsx(ds,{querySearchFilter:u,isFiltered:v,pagination:l,selectedCves:m,canSelectRows:T,createRowActions:E("CLUSTER_CVE",g?"UNSNOOZE":"SNOOZE"),sortOption:o,getSortParams:c,onClearFilters:q}),n==="Cluster"&&e.jsx(is,{querySearchFilter:u,isFiltered:v,pagination:l,sortOption:o,getSortParams:c,onClearFilters:q})]}),N.modalsFragment]})}const hs=[B,Y,J],ys={field:B,direction:"asc"},fs=j`
...
`;function Os(s){return I(qs,{variables:{id:s}})}function Ne(s){if(!s)return null;const{region:t}=s;return s.aws?`AWS ${t}`:s.azure?`Azure ${t}`:s.google?`GCP ${t}`:null}function As({clusterId:s}){var r,i,l,o,c,p;const{data:t,loading:a,error:n}=Os(s);return e.jsxs(e.Fragment,{children:[e.jsx(b,{component:"div",children:e.jsx(_,{component:"p",children:"View details about this cluster"})}),e.jsx(z,{component:"div"}),e.jsx(b,{isFilled:!0,children:n?e.jsx(ve,{children:e.jsx(ct,{title:"There was an error loading the cluster details",headingLevel:"h2",icon:dt,status:"danger",children:ut(n)})}):a?e.jsx(ve,{children:e.jsx(wt,{size:"xl"})}):t&&e.jsxs(D,{direction:{default:"column"},spaceItems:{default:"spaceItemsXl"},children:[e.jsxs(Nt,{columnModifier:{default:"1Col"},children:[e.jsxs(Q,{children:[e.jsx(G,{children:"Cluster type"}),e.jsx(W,{children:Ee(t.cluster.type)})]}),Ne((r=t.cluster.status)==null?void 0:r.providerMetadata)&&e.jsxs(Q,{children:[e.jsx(G,{children:"Cloud provider"}),e.jsx(W,{children:Ne((i=t.cluster.status)==null?void 0:i.providerMetadata)})]}),((o=(l=t.cluster.status)==null?void 0:l.orchestratorMetadata)==null?void 0:o.buildDate)&&e.jsxs(Q,{children:[e.jsx(G,{children:"Build date"}),e.jsx(W,{children:_e(t.cluster.status.orchestratorMetadata.buildDate)})]}),((p=(c=t.cluster.status)==null?void 0:c.orchestratorMetadata)==null?void 0:p.version)&&e.jsxs(Q,{children:[e.jsx(G,{children:"K8s version"}),e.jsx(W,{children:t.cluster.status.orchestratorMetadata.version})]})]}),e.jsx(rs,{toggleText:"Labels",labels:t.cluster.labels})]})})]})}const _s=[ce,pt,ue,w],Rs={field:w,direction:"desc"},Bs=j`
...
`;function ws({tableState:s,getSortParams:t,onClearFilters:a}){const r=Ue();return e.jsxs(re,{borders:s.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":s.type==="LOADING"?"true":"false",children:[e.jsx(ae,{noWrap:!0,children:e.jsxs($,{children:[e.jsx(Ke,{}),e.jsx(f,{sort:t(ce),children:"CVE"}),e.jsx(f,{sort:t(pt),children:"CVE status"}),e.jsx(f,{sort:t(ue),children:"CVE type"}),e.jsx(f,{sort:t(w),children:"CVSS"})]})}),e.jsx(ne,{tableState:s,colSpan:5,emptyProps:{message:"No CVEs were detected for this cluster"},filteredEmptyProps:{onClearFilters:a},renderer:({data:i})=>i.map((l,o)=>{const{id:c,cve:p,isFixable:u,vulnerabilityType:v,cvss:g,scoreVersion:T,summary:m}=l,V=r.has(p);return e.jsxs(ie,{isExpanded:V,children:[e.jsxs($,{children:[e.jsx(d,{expand:{rowIndex:o,isExpanded:V,onToggle:()=>r.toggle(p)}}),e.jsx(d,{dataLabel:"CVE",modifier:"nowrap",children:e.jsx(le,{to:oe("CVE",c),children:p})}),e.jsx(d,{dataLabel:"CVE status",children:e.jsx(Se,{isFixable:u})}),e.jsx(d,{dataLabel:"CVE type",children:ze(v)}),e.jsx(d,{dataLabel:"CVSS",children:e.jsx(Qe,{cvss:g,scoreVersion:T})})]}),e.jsxs($,{isExpanded:V,children:[e.jsx(d,{}),e.jsx(d,{colSpan:4,children:e.jsx(Ge,{children:m?e.jsx(_,{component:"p",children:m}):e.jsx(We,{})})})]})]},p)})})]})}const Ns=j`
    ${Bs}
...
`;function Ms({clusterId:s,query:t,...a}){return I(Ns,{variables:{id:s,query:t,pagination:ee(a)}})}const ks="var(--pf-t--global--text--color--disabled)",Us=[{status:"Fixable",Icon:Mt,text:({fixable:s})=>`${R(s,"vulnerability","vulnerabilities")} with available fixes`},{status:"Not fixable",Icon:kt,text:({total:s,fixable:t})=>`${R(s-t,"vulnerability","vulnerabilities")} without fixes`}],Ks={Fixable:"Fixable hidden","Not fixable":"Not fixable hidden"},zs=j`
...
`;function Hs({data:s}){return e.jsxs(pe,{isCompact:!0,isFullHeight:!0,children:[e.jsx(me,{children:"CVEs by type"}),e.jsx(xe,{children:e.jsx(D,{direction:{default:"column"},children:Gs.map(({type:t,field:a})=>e.jsx(je,{span:12,children:e.jsx(_,{component:"p",children:R(s[a],t)})},t))})})]})}const Zs=j`
    ${zs}
    ${Ws}
...
`;function Xs(s,t){return I(Zs,{variables:{id:s,query:t}})}const Ys=[Xe];function Js({clusterId:s}){var S,q;const{analyticsTrack:t}=Te(),a=qe(t),{searchFilter:n,setSearchFilter:r}=Ve(),i=Ie(n),l=Ut(i),o=$e(i),{page:c,perPage:p,setPage:u,setPerPage:v}=Fe(Le),{sortOption:g,getSortParams:T}=Pe({sortFields:_s,defaultSortOption:Rs,onSort:()=>u(1)}),{data:m,loading:V,error:P}=Ms({clusterId:s,query:l,page:c,perPage:p,sortOption:g}),E=Xs(s,l),F=Kt(i),x=((S=m==null?void 0:m.cluster)==null?void 0:S.clusterVulnerabilityCount)??0,y=se({isLoading:V,error:P,data:(q=m==null?void 0:m.cluster)==null?void 0:q.clusterVulnerabilities,searchFilter:i});return e.jsxs(e.Fragment,{children:[e.jsx(b,{component:"div",children:e.jsx(_,{component:"p",children:"Review and triage vulnerability data scanned on this cluster"})}),e.jsx(z,{component:"div"}),e.jsxs(b,{hasBodyWrapper:!1,isFilled:!0,children:[e.jsx(De,{className:"pf-v6-u-pb-0 pf-v6-u-px-sm",searchFilter:n,searchFilterConfig:Ys,cveStatusFilterField:"CLUSTER CVE FIXABLE",onFilterChange:(h,C)=>{r(h),a(Oe,C)},includeCveSeverityFilters:!1}),e.jsxs(nt,{isLoading:E.loading,error:E.error,children:[e.jsx(Z,{loadingText:"Loading platform CVEs by status summary",data:E.data,renderer:({data:h})=>e.jsx(Qs,{data:h.cluster.platformCVECountByFixability,hiddenStatuses:F})}),e.jsx(Z,{loadingText:"Loading platform CVEs by type summary",data:E.data,renderer:({data:h})=>e.jsx(Hs,{data:h.cluster.platformCVECountByType})})]}),e.jsx(z,{component:"div"}),e.jsxs(it,{hasGutter:!0,className:"pf-v6-u-align-items-baseline",children:[e.jsx(X,{isFilled:!0,children:e.jsxs(D,{alignItems:{default:"alignItemsCenter"},children:[e.jsx(K,{headingLevel:"h2",className:"pf-v6-u-w-50",children:m?`${R(x,"result")} found`:e.jsx(Ae,{screenreaderText:"Loading cluster vulnerability count"})}),o&&e.jsx(lt,{})]})}),e.jsx(X,{children:e.jsx(ot,{itemCount:x,perPage:p,page:c,onSetPage:(h,C)=>u(C),onPerPageSelect:(h,C)=>{v(C)}})})]}),e.jsx(ws,{tableState:y,getSortParams:T,onClearFilters:()=>{r({}),u(1)}})]})]})}const er="ClusterPageDetails",tr="ClusterPageVulnerabilities",sr=tt("Platform",{entityTab:"Cluster"}),rr=j`
    ${$s}
...
`;function ar(){var c;const{clusterId:s}=Ye(),{data:t,error:a}=I(rr,{variables:{id:s}}),[n,r]=He("detailsTab",fe),i=fe[0],l=fe[1],o=((c=t==null?void 0:t.cluster)==null?void 0:c.name)??"";return e.jsxs(e.Fragment,{children:[e.jsx(de,{title:`Platform CVEs - Cluster ${o}`}),e.jsx(b,{type:"breadcrumb",children:e.jsxs(Je,{children:[e.jsx(et,{to:sr,children:"Clusters"}),e.jsx(st,{isActive:!0,children:o??e.jsx(Ae,{screenreaderText:"Loading cluster name",width:"200px"})})]})}),a?e.jsx(b,{hasBodyWrapper:!1,children:e.jsx(ve,{children:e.jsx(ct,{title:ut(a),headingLevel:"h2",icon:dt,status:"danger"})})}):e.jsxs(e.Fragment,{children:[e.jsx(b,{hasBodyWrapper:!1,children:e.jsx(Ds,{data:t==null?void 0:t.cluster})}),e.jsx(b,{type:"tabs",children:e.jsxs(zt,{activeKey:n,onSelect:(p,u)=>{r(u)},usePageInsets:!0,mountOnEnter:!0,unmountOnExit:!0,children:[e.jsx(Re,{eventKey:i,tabContentId:tr,title:i,children:e.jsx(Js,{clusterId:s})}),e.jsx(Re,{eventKey:l,tabContentId:er,title:l,children:e.jsx(As,{clusterId:s})})]})})]})]})}function pr(){const{hasReadAccess:s}=Qt(),t=s("Integration");return e.jsxs(e.Fragment,{children:[t&&e.jsx(Gt,{}),e.jsxs(Wt,{children:[e.jsx(H,{index:!0,element:e.jsx(Cs,{})}),e.jsx(H,{path:"cves/:cveId",element:e.jsx(Is,{})}),e.jsx(H,{path:"clusters/:clusterId",element:e.jsx(ar,{})}),e.jsx(H,{path:"*",element:e.jsxs(b,{hasBodyWrapper:!1,children:[e.jsx(de,{title:"Platform CVEs - Not Found"}),e.jsx(Ht,{})]})})]})]})}export{pr as default};
