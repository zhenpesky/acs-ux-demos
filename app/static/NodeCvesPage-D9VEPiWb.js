import{cj as re,m9 as G,ma as ie,mb as Se,mc as Nt,dy as de,eI as be,md as Xe,me as Ye,w as e,aF as W,aG as H,a4 as F,mf as Je,mg as Tt,aH as h,mh as ze,mi as Ce,lW as Ft,lX as Lt,dk as le,lZ as It,l_ as Ot,aI as Z,aw as d,mj as Dt,b8 as ce,mk as ue,l$ as et,m0 as Ee,m1 as tt,bb as Pt,cw as Ve,am as Ne,ml as $t,mm as X,mn as me,mo as xe,mp as nt,dQ as k,bN as Te,eu as wt,d6 as st,mq as At,cA as Fe,cz as Le,lP as Ie,cB as Oe,jT as qt,mr as De,dz as Pe,ms as Rt,bO as _t,kD as kt,kE as Bt,kF as Mt,lR as $e,mt as ot,mu as at,mv as rt,mw as we,lI as Ae,mx as qe,my as zt,ao as he,ab as S,aB as B,ac as pe,aC as Ue,ai as Ut,bT as Qt,bU as Kt,mz as Gt,aW as Wt,bS as Ht,K as Zt,mA as Xt,mB as Yt,jF as Jt,mC as Re,fg as en,mD as M,mE as je,mF as ge,mG as it,mH as dt,mI as tn,mJ as lt,b9 as Y,aQ as nn,aS as sn,aT as on,bK as an,bo as Qe,bi as ct,mK as ut,be as mt,bf as xt,mL as ht,bg as pt,e7 as _e,mM as rn,bh as K,mN as jt,mO as oe,mP as gt,d$ as yt,fY as ae,mQ as Ct,cy as ft,mR as dn,e6 as ln,aZ as ne,de as fe,mS as cn,mT as un,mU as mn,bk as ve,bX as vt,cq as St,dN as bt,bl as xn,cm as hn,cn as q,co as R,cp as _,mV as ye,ad as pn,ae as Ke,b4 as jn,mW as gn,cg as yn,ch as se,f3 as Cn}from"./index-Ck15XR_I.js";import{u as I,g as V,f as fn,r as vn}from"./apollo-BxVF6eGb.js";import{u as Sn,a as bn,b as En,S as Vn,c as Nn,E as Ge}from"./ExpandableLabelSection-D-TdQsgq.js";import"./react-pF2EnNv3.js";import"./lodash-JMWJiBov.js";import"./timeWindows-jJwZwJb_.js";import"./VulnerabilitiesService-Bg6OPfmB.js";const Tn=V`
...
`;function $n({querySearchFilter:n,...t}){return I(Pn,{variables:{query:G(n),pagination:re(t)}})}const wn=[X,me,xe,nt],He={field:X,direction:"asc"};function An({querySearchFilter:n,isFiltered:t,pagination:s,sortOption:r,getSortParams:o,onClearFilters:a}){var f;const{page:x,perPage:c}=s,{data:i,previousData:g,loading:m,error:y}=$n({querySearchFilter:n,page:x,perPage:c,sortOption:r}),j=i??g,C=de({isLoading:m,data:j==null?void 0:j.nodes,error:y,searchFilter:n}),b=(f=n.SEVERITY)==null?void 0:f.map(l=>Xe[l]).filter(Ye);return e.jsxs(W,{borders:C.type==="COMPLETE",variant:"compact","aria-live":"polite","aria-busy":m?"true":"false",children:[e.jsx(H,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(h,{sort:o(X),children:"Node"}),e.jsxs(h,{children:["CVEs by severity",t&&e.jsx(Ce,{})]}),e.jsx(h,{sort:o(me),children:"Cluster"}),e.jsx(h,{sort:o(xe),children:"Operating system"}),e.jsx(h,{sort:o(nt),children:"Scan time"})]})}),e.jsx(le,{tableState:C,colSpan:5,emptyProps:{message:"No CVEs have been reported for your scanned nodes"},filteredEmptyProps:{onClearFilters:a},renderer:({data:l})=>e.jsx(Z,{children:l.map(v=>{const{id:T,name:E,nodeCVECountBySeverity:O,cluster:D,osImage:N,scanTime:L}=v,{critical:u,important:p,moderate:P,low:A,unknown:z}=O;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Node",modifier:"nowrap",children:e.jsx(ce,{to:ue("Node",T),children:e.jsx(k,{position:"middle",content:E})})}),e.jsx(d,{dataLabel:"CVEs by severity",children:e.jsx(et,{criticalCount:u.total,importantCount:p.total,moderateCount:P.total,lowCount:A.total,unknownCount:z.total,filteredSeverities:b,entity:"node"})}),e.jsx(d,{dataLabel:"Cluster",modifier:"nowrap",children:e.jsx(k,{position:"middle",content:D.name})}),e.jsx(d,{dataLabel:"Operating system",modifier:"nowrap",children:e.jsx(k,{position:"middle",content:N})}),e.jsx(d,{dataLabel:"Scan time",children:e.jsx(tt,{date:L})})]},T)})})})]})}const qn=V`
    query getNodeCVEEntityCounts($query: String) {
        nodeCVECount(query: $query)
        nodeCount(query: $query)
    }
`;function Rn(n){return I(qn,{variables:{query:G(n)}})}const _n=[ot,at,rt,we];function kn(){var te;const n=fn(),{analyticsTrack:t}=Te(),s=Ae(t),{isFeatureFlagEnabled:r}=wt(),o=r("ROX_SCANNER_V4")&&r("ROX_NODE_INDEX_ENABLED"),[a]=st("entityTab",At),{searchFilter:x,setSearchFilter:c}=Fe(),i=Le(Ie),{sortOption:g,getSortParams:m,setSortOption:y}=Oe({sortFields:a==="CVE"?On:wn,defaultSortOption:a==="CVE"?We:He,onSort:()=>i.setPage(1)});qt({destination:"node-cves",searchFilter:x,setSearchFilter:c,reapplyWhen:[a],onScopeApplied:()=>i.setPage(1)});const j=De(x),C=Pe(j),b=((te=j["CVE Snoozed"])==null?void 0:te[0])==="true",f=Sn(),l=Rt(),{snoozeModalOptions:v,setSnoozeModalOptions:T,snoozeActionCreator:E}=bn(),O=En("Node"),{version:D}=_t();function N($){i.setPage(1),y($==="CVE"?We:He),t({event:Xt,properties:{type:$,page:"Overview"}})}vn.useEffect(()=>{N(a)},[]);function L(){c({}),i.setPage(1)}const{data:u}=Rn(j),p={CVE:(u==null?void 0:u.nodeCVECount)??0,Node:(u==null?void 0:u.nodeCount)??0},P=kt(),A=P==="v1"||P==="v2",z=Bt({enabled:A&&P==="v1",searchFilter:x,setSearchFilter:c,paginationSetPage:()=>i.setPage(1),storageScope:"node-cves",filterKind:"workload"}),U=Mt({enabled:A&&P==="v2",searchFilter:x,setSearchFilter:c,paginationSetPage:()=>i.setPage(1),storageScope:"node-cves",filterKind:"workload"}),Q=P==="v2"?U:z,J=e.jsx($e,{searchFilter:x,searchFilterConfig:_n,defaultSearchFilterEntity:"Node",onFilterChange:($,w)=>{c($),i.setPage(1),s(qe,w)},prefixToolbarItems:Q.prefixToolbarItem??void 0,appliedFilterSuffix:Q.appliedFilterSuffix??void 0}),ee=e.jsx(Yt,{entityTabs:["CVE","Node"],entityCounts:p,onChange:N});return e.jsxs(e.Fragment,{children:[v&&e.jsx(Vn,{...v,onSuccess:($,w)=>{$==="SNOOZE"&&t({event:zt,properties:{type:"NODE",duration:w}}),n.cache.evict({fieldName:"nodeCVEs"}),n.cache.evict({fieldName:"nodeCVECount"}),n.cache.gc(),l.clear()},onClose:()=>T(null)}),e.jsx(he,{title:"Node CVEs Overview"}),e.jsx(S,{children:e.jsxs(B,{alignItems:{default:"alignItemsCenter"},grow:{default:"grow"},children:[e.jsxs(B,{direction:{default:"column"},grow:{default:"grow"},children:[e.jsx(pe,{headingLevel:"h1",children:"Node CVEs"}),e.jsx(Ue,{children:"Prioritize and manage scanned CVEs across nodes"})]}),e.jsx(Ue,{children:e.jsx(Nn,{searchFilter:x,setSearchFilter:c,snoozedCveCount:O})})]})}),o&&e.jsx(S,{children:e.jsx(Ut,{isInline:!0,variant:"info",title:"Results may include Node CVEs obtained from Scanner V4",component:"p",children:e.jsx(Qt,{children:e.jsx("a",{href:Kt(D,"operating/managing-vulnerabilities#understanding-node-cves-scanner-v4_scan-rhcos-node-host"),target:"_blank",rel:"noopener noreferrer",children:"Read more about the differences between the node scanning results obtained with the StackRox Scanner and Scanner V4."})})})}),P==="v2"&&U.wysiwygAlert&&e.jsx(S,{children:U.wysiwygAlert}),e.jsxs(S,{isCenterAligned:!0,children:[e.jsx(Gt,{filterToolbar:J,entityToggleGroup:ee,pagination:i,tableRowCount:a==="CVE"?p.CVE:p.Node,isFiltered:C,children:f&&e.jsx(Wt,{align:{default:"alignEnd"},children:e.jsx(Ht,{toggleText:"Bulk actions",isDisabled:l.size===0,children:e.jsx(Zt,{onClick:()=>T({action:b?"UNSNOOZE":"SNOOZE",cveType:"NODE_CVE",cves:Array.from(l.values())}),children:b?"Unsnooze CVEs":"Snooze CVEs"},"bulk-snooze-cve")})})}),a==="CVE"&&e.jsx(Dn,{querySearchFilter:j,isFiltered:C,pagination:i,selectedCves:l,canSelectRows:f,createRowActions:E("NODE_CVE",b?"UNSNOOZE":"SNOOZE"),sortOption:g,getSortParams:m,onClearFilters:L}),a==="Node"&&e.jsx(An,{querySearchFilter:j,isFiltered:C,pagination:i,sortOption:g,getSortParams:m,onClearFilters:L})]}),Q.modalsFragment]})}function Bn(n,t){const s=en(n,r=>{var o,a;switch(t.field){case"Component":return(o=r.name)==null?void 0:o.toLowerCase();case"Type":return(a=r.source)==null?void 0:a.toLowerCase();default:return""}});return t.reversed&&s.reverse(),s}const Et=V`
...
`,Mn=["Component","Type"],zn={field:"Component",direction:"asc"};function Vt({data:n}){const{sortOption:t,getSortParams:s}=Jt({sortFields:Mn,defaultSortOption:zn}),r=Bn(n,t);return n.length===0?null:e.jsxs(W,{children:[e.jsx(H,{noWrap:!0,children:e.jsxs(F,{children:[e.jsx(h,{sort:s("Component"),children:"Component"}),e.jsx(h,{children:"Version"}),e.jsx(h,{children:"CVE fixed in"}),e.jsx(h,{sort:s("Type"),children:"Type"})]})}),e.jsx(Z,{children:r.map(({name:o,source:a,version:x,nodeVulnerabilities:c})=>{var g;const i=(g=c==null?void 0:c[0])==null?void 0:g.fixedByVersion;return e.jsxs(F,{children:[e.jsx(d,{dataLabel:"Component",children:o}),e.jsx(d,{dataLabel:"Version",children:x}),e.jsx(d,{dataLabel:"CVE fixed in",children:i||e.jsx(Re,{isFixable:!1})}),e.jsx(d,{dataLabel:"Type",children:a})]},o)})})]})}const Un=[X,M,je,ge,me,xe],Qn={field:M,direction:"desc"},Kn=V`
    ${Et}
