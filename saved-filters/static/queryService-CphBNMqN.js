var Rn=Object.defineProperty;var wn=(a,e,r)=>e in a?Rn(a,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[e]=r;var ae=(a,e,r)=>wn(a,typeof e!="symbol"?e+"":e,r);import{t as Dn,f3 as p,ah as nt,a8 as _n}from"./index-OxCr893w.js";import{g as y}from"./apollo-Bv6hvkNJ.js";import{c as An}from"./controls-CGUivZmM.js";import{n as Fn,c as f,r as rt,P as o,k as zn}from"./redoc-DSdxMpMR.js";import{g as _t}from"./lodash-JMWJiBov.js";const At=a=>{if(!a)return a;const e={};return Object.keys(a).forEach(r=>{if(Object.prototype.hasOwnProperty.call(a,r))if(typeof a[r]=="object"&&!Array.isArray(a[r])){const t=At(a[r]);t&&Object.keys(t).forEach(n=>{Object.prototype.hasOwnProperty.call(t,n)&&(e[`${r}.${n}`]=t[n])})}else e[r]=a[r]}),e},Ft=y`
